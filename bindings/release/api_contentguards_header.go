...
*/
func (a *ContentguardsHeaderAPIService) ContentguardsCoreHeaderCreate(ctx context.Context) ContentguardsHeaderAPIContentguardsCoreHeaderCreateRequest {
	return ContentguardsHeaderAPIContentguardsCoreHeaderCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ContentguardsHeaderAPIService) ContentguardsCoreHeaderCreateExecute(r ContentguardsHeaderAPIContentguardsCoreHeaderCreateRequest) (*HeaderContentGuardResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/contentguards/core/header/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
*/
func (a *ContentguardsHeaderAPIService) ContentguardsCoreHeaderList(ctx context.Context) ContentguardsHeaderAPIContentguardsCoreHeaderListRequest {
	return ContentguardsHeaderAPIContentguardsCoreHeaderListRequest{
		ApiService: a,
		ctx: ctx,
	}
