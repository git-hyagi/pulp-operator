...
*/
func (a *DistributionsOpenpgpAPIService) DistributionsCoreOpenpgpCreate(ctx context.Context) DistributionsOpenpgpAPIDistributionsCoreOpenpgpCreateRequest {
	return DistributionsOpenpgpAPIDistributionsCoreOpenpgpCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DistributionsOpenpgpAPIService) DistributionsCoreOpenpgpCreateExecute(r DistributionsOpenpgpAPIDistributionsCoreOpenpgpCreateRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/distributions/core/openpgp/"
...
*/
func (a *DistributionsOpenpgpAPIService) DistributionsCoreOpenpgpList(ctx context.Context) DistributionsOpenpgpAPIDistributionsCoreOpenpgpListRequest {
	return DistributionsOpenpgpAPIDistributionsCoreOpenpgpListRequest{
		ApiService: a,
		ctx: ctx,
	}
