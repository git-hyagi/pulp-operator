...
// checks if the OpenPGPKeyringResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenPGPKeyringResponse{}

// OpenPGPKeyringResponse Base serializer for use with [pulpcore.app.models.Model][]This ensures that all Serializers provide values for the 'pulp_href` field.The class provides a default for the ``ref_name`` attribute in theModelSerializers's ``Meta`` class. This ensures that the OpenAPI definitionsof plugins are namespaced properly.
type OpenPGPKeyringResponse struct {
...
type _OpenPGPKeyringResponse OpenPGPKeyringResponse
...
func (o *OpenPGPKeyringResponse) SetDescriptionNil() {
...
func (o *OpenPGPKeyringResponse) SetRetainRepoVersionsNil() {
...
func (o *OpenPGPKeyringResponse) SetRemoteNil() {
	o.Remote.Set(nil)
}
...
func (o OpenPGPKeyringResponse) MarshalJSON() ([]byte, error) {
...
func (o OpenPGPKeyringResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OpenPGPKeyringResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenPGPKeyringResponse := _OpenPGPKeyringResponse{}

	err = json.Unmarshal(data, &varOpenPGPKeyringResponse)

	if err != nil {
		return err
	}

	*o = OpenPGPKeyringResponse(varOpenPGPKeyringResponse)
...
type NullableOpenPGPKeyringResponse struct {
	value *OpenPGPKeyringResponse
	isSet bool
}

func (v NullableOpenPGPKeyringResponse) Get() *OpenPGPKeyringResponse {
	return v.value
}

func (v *NullableOpenPGPKeyringResponse) Set(val *OpenPGPKeyringResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenPGPKeyringResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenPGPKeyringResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenPGPKeyringResponse(val *OpenPGPKeyringResponse) *NullableOpenPGPKeyringResponse {
	return &NullableOpenPGPKeyringResponse{value: val, isSet: true}
}

func (v NullableOpenPGPKeyringResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenPGPKeyringResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
