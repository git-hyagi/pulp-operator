...
func (a *DomainsAPIService) DomainsCreateExecute(r DomainsAPIDomainsCreateRequest) (*DomainResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/domains/"
...
*/
func (a *DomainsAPIService) DomainsMigrate(ctx context.Context) DomainsAPIDomainsMigrateRequest {
	return DomainsAPIDomainsMigrateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DomainsAPIService) DomainsMigrateExecute(r DomainsAPIDomainsMigrateRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/domains/migrate/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
