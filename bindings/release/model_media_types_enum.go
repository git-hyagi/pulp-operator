...
const (
	MEDIATYPESENUM_APPLICATION_VND_DOCKER_DISTRIBUTION_MANIFEST_V1JSON MediaTypesEnum = "application/vnd.docker.distribution.manifest.v1+json"
	MEDIATYPESENUM_APPLICATION_VND_DOCKER_DISTRIBUTION_MANIFEST_V2JSON MediaTypesEnum = "application/vnd.docker.distribution.manifest.v2+json"
	MEDIATYPESENUM_APPLICATION_VND_DOCKER_DISTRIBUTION_MANIFEST_LIST_V2JSON MediaTypesEnum = "application/vnd.docker.distribution.manifest.list.v2+json"
	MEDIATYPESENUM_APPLICATION_VND_OCI_IMAGE_MANIFEST_V1JSON MediaTypesEnum = "application/vnd.oci.image.manifest.v1+json"
	MEDIATYPESENUM_APPLICATION_VND_OCI_IMAGE_INDEX_V1JSON MediaTypesEnum = "application/vnd.oci.image.index.v1+json"
)
