...
func (r PulpAnsibleTagsAPIPulpAnsibleTagsListRequest) XTaskDiagnostics(xTaskDiagnostics []string) PulpAnsibleTagsAPIPulpAnsibleTagsListRequest {
...
/*
PulpAnsibleTagsList List collection versions
...
func (a *PulpAnsibleTagsAPIService) PulpAnsibleTagsListExecute(r PulpAnsibleTagsAPIPulpAnsibleTagsListRequest) (*PaginatedTagResponseList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/pulp_ansible/tags/"
