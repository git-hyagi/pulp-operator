...
// checks if the PatcheddebAptDistribution type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatcheddebAptDistribution{}

// PatcheddebAptDistribution Serializer for AptDistributions.
type PatcheddebAptDistribution struct {
...
type _PatcheddebAptDistribution PatcheddebAptDistribution
...
func NewPatcheddebAptDistribution() *PatcheddebAptDistribution {
	this := PatcheddebAptDistribution{}
...
func (o *PatcheddebAptDistribution) SetContentGuardNil() {
...
func (o *PatcheddebAptDistribution) SetRepositoryNil() {
...
func (o *PatcheddebAptDistribution) SetPublicationNil() {
...
func (o PatcheddebAptDistribution) MarshalJSON() ([]byte, error) {
...
func (o PatcheddebAptDistribution) ToMap() (map[string]interface{}, error) {
...
func (o *PatcheddebAptDistribution) UnmarshalJSON(data []byte) (err error) {
	varPatcheddebAptDistribution := _PatcheddebAptDistribution{}

	err = json.Unmarshal(data, &varPatcheddebAptDistribution)

	if err != nil {
		return err
	}

	*o = PatcheddebAptDistribution(varPatcheddebAptDistribution)
...
type NullablePatcheddebAptDistribution struct {
	value *PatcheddebAptDistribution
	isSet bool
}

func (v NullablePatcheddebAptDistribution) Get() *PatcheddebAptDistribution {
	return v.value
}

func (v *NullablePatcheddebAptDistribution) Set(val *PatcheddebAptDistribution) {
	v.value = val
	v.isSet = true
}

func (v NullablePatcheddebAptDistribution) IsSet() bool {
	return v.isSet
}

func (v *NullablePatcheddebAptDistribution) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatcheddebAptDistribution(val *PatcheddebAptDistribution) *NullablePatcheddebAptDistribution {
	return &NullablePatcheddebAptDistribution{value: val, isSet: true}
}

func (v NullablePatcheddebAptDistribution) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatcheddebAptDistribution) UnmarshalJSON(src []byte) error {
	v.isSet = true
