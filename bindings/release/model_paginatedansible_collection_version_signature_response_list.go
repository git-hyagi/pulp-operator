...
type PaginatedansibleCollectionVersionSignatureResponseList struct {
	...
	Results []AnsibleCollectionVersionSignatureResponse `json:"results"`
...
func (o *PaginatedansibleCollectionVersionSignatureResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPaginatedansibleCollectionVersionSignatureResponseList)
