...
// checks if the AnsibleAnsibleCollectionDeprecatedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnsibleAnsibleCollectionDeprecatedResponse{}

// AnsibleAnsibleCollectionDeprecatedResponse A serializer for Ansible Collection Deprecations.
type AnsibleAnsibleCollectionDeprecatedResponse struct {
...
type _AnsibleAnsibleCollectionDeprecatedResponse AnsibleAnsibleCollectionDeprecatedResponse
...
func NewAnsibleAnsibleCollectionDeprecatedResponse(name string, namespace string) *AnsibleAnsibleCollectionDeprecatedResponse {
	this := AnsibleAnsibleCollectionDeprecatedResponse{}
	this.Name = name
...
func (o AnsibleAnsibleCollectionDeprecatedResponse) MarshalJSON() ([]byte, error) {
...
func (o AnsibleAnsibleCollectionDeprecatedResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AnsibleAnsibleCollectionDeprecatedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAnsibleAnsibleCollectionDeprecatedResponse := _AnsibleAnsibleCollectionDeprecatedResponse{}

	err = json.Unmarshal(data, &varAnsibleAnsibleCollectionDeprecatedResponse)

	if err != nil {
		return err
	}

	*o = AnsibleAnsibleCollectionDeprecatedResponse(varAnsibleAnsibleCollectionDeprecatedResponse)
...
type NullableAnsibleAnsibleCollectionDeprecatedResponse struct {
	value *AnsibleAnsibleCollectionDeprecatedResponse
	isSet bool
}

func (v NullableAnsibleAnsibleCollectionDeprecatedResponse) Get() *AnsibleAnsibleCollectionDeprecatedResponse {
	return v.value
}

func (v *NullableAnsibleAnsibleCollectionDeprecatedResponse) Set(val *AnsibleAnsibleCollectionDeprecatedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAnsibleAnsibleCollectionDeprecatedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAnsibleAnsibleCollectionDeprecatedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnsibleAnsibleCollectionDeprecatedResponse(val *AnsibleAnsibleCollectionDeprecatedResponse) *NullableAnsibleAnsibleCollectionDeprecatedResponse {
	return &NullableAnsibleAnsibleCollectionDeprecatedResponse{value: val, isSet: true}
}

func (v NullableAnsibleAnsibleCollectionDeprecatedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnsibleAnsibleCollectionDeprecatedResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
