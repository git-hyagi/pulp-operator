...
type _UnpaginatedCollectionVersionResponse UnpaginatedCollectionVersionResponse
...
func (o *UnpaginatedCollectionVersionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUnpaginatedCollectionVersionResponse := _UnpaginatedCollectionVersionResponse{}

	err = json.Unmarshal(data, &varUnpaginatedCollectionVersionResponse)

	if err != nil {
		return err
	}

	*o = UnpaginatedCollectionVersionResponse(varUnpaginatedCollectionVersionResponse)
