...
func (o *PaginatedRepositoryResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedRepositoryResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedRepositoryResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPaginatedRepositoryResponseList)
