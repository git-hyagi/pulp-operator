...
// checks if the DebPackageReleaseComponentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DebPackageReleaseComponentResponse{}

// DebPackageReleaseComponentResponse A Serializer for PackageReleaseComponent.
type DebPackageReleaseComponentResponse struct {
...
type _DebPackageReleaseComponentResponse DebPackageReleaseComponentResponse
...
func NewDebPackageReleaseComponentResponse(package_ string, releaseComponent string) *DebPackageReleaseComponentResponse {
	this := DebPackageReleaseComponentResponse{}
...
func (o DebPackageReleaseComponentResponse) MarshalJSON() ([]byte, error) {
...
func (o DebPackageReleaseComponentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DebPackageReleaseComponentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDebPackageReleaseComponentResponse := _DebPackageReleaseComponentResponse{}

	err = json.Unmarshal(data, &varDebPackageReleaseComponentResponse)

	if err != nil {
		return err
	}

	*o = DebPackageReleaseComponentResponse(varDebPackageReleaseComponentResponse)
...
type NullableDebPackageReleaseComponentResponse struct {
	value *DebPackageReleaseComponentResponse
	isSet bool
}

func (v NullableDebPackageReleaseComponentResponse) Get() *DebPackageReleaseComponentResponse {
	return v.value
}

func (v *NullableDebPackageReleaseComponentResponse) Set(val *DebPackageReleaseComponentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDebPackageReleaseComponentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDebPackageReleaseComponentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDebPackageReleaseComponentResponse(val *DebPackageReleaseComponentResponse) *NullableDebPackageReleaseComponentResponse {
	return &NullableDebPackageReleaseComponentResponse{value: val, isSet: true}
}

func (v NullableDebPackageReleaseComponentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDebPackageReleaseComponentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
