...
*/
func (a *RepositoriesOpenpgpKeyringAPIService) RepositoriesCoreOpenpgpKeyringCreate(ctx context.Context) RepositoriesOpenpgpKeyringAPIRepositoriesCoreOpenpgpKeyringCreateRequest {
	return RepositoriesOpenpgpKeyringAPIRepositoriesCoreOpenpgpKeyringCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RepositoriesOpenpgpKeyringAPIService) RepositoriesCoreOpenpgpKeyringCreateExecute(r RepositoriesOpenpgpKeyringAPIRepositoriesCoreOpenpgpKeyringCreateRequest) (*OpenPGPKeyringResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/repositories/core/openpgp_keyring/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
*/
func (a *RepositoriesOpenpgpKeyringAPIService) RepositoriesCoreOpenpgpKeyringList(ctx context.Context) RepositoriesOpenpgpKeyringAPIRepositoriesCoreOpenpgpKeyringListRequest {
	return RepositoriesOpenpgpKeyringAPIRepositoriesCoreOpenpgpKeyringListRequest{
		ApiService: a,
		ctx: ctx,
	}
