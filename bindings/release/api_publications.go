...
// Pulp type* &#x60;deb.verbatim-publication&#x60; - deb.verbatim-publication* &#x60;deb.apt-publication&#x60; - deb.apt-publication* &#x60;python.python&#x60; - python.python* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;file.file&#x60; - file.file
func (r PublicationsAPIPublicationsListRequest) PulpType(pulpType string) PublicationsAPIPublicationsListRequest {
	r.pulpType = &pulpType
	return r
}

// Multiple values may be separated by commas.* &#x60;deb.verbatim-publication&#x60; - deb.verbatim-publication* &#x60;deb.apt-publication&#x60; - deb.apt-publication* &#x60;python.python&#x60; - python.python* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;file.file&#x60; - file.file
...
func (a *PublicationsAPIService) PublicationsListExecute(r PublicationsAPIPublicationsListRequest) (*PaginatedPublicationResponseList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/publications/"
