...
type PaginatedansibleCollectionRemoteResponseList struct {
	...
	Results []AnsibleCollectionRemoteResponse `json:"results"`
...
func (o *PaginatedansibleCollectionRemoteResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPaginatedansibleCollectionRemoteResponseList)
