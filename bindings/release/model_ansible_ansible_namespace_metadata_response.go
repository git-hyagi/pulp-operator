...
type AnsibleAnsibleNamespaceMetadataResponse struct {
	...
	Name string `json:"name" validate:"regexp=^(?!.*__)[a-z]+[0-9a-z_]*$"`
...
func (o *AnsibleAnsibleNamespaceMetadataResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAnsibleAnsibleNamespaceMetadataResponse)
