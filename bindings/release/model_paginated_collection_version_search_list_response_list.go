...
func (o *PaginatedCollectionVersionSearchListResponseList) UnmarshalJSON(data []byte) (err error) {
	varPaginatedCollectionVersionSearchListResponseList := _PaginatedCollectionVersionSearchListResponseList{}

	err = json.Unmarshal(data, &varPaginatedCollectionVersionSearchListResponseList)
