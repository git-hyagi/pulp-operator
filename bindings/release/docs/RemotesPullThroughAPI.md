...
[**RemotesContainerPullThroughCreate**](RemotesPullThroughAPI.md#RemotesContainerPullThroughCreate) | **Post** /api/v3/remotes/container/pull-through/ | Create a container pull through remote
...
[**RemotesContainerPullThroughList**](RemotesPullThroughAPI.md#RemotesContainerPullThroughList) | **Get** /api/v3/remotes/container/pull-through/ | List container pull through remotes
...
> ContainerContainerPullThroughRemoteResponse RemotesContainerPullThroughCreate(ctx).ContainerContainerPullThroughRemote(containerContainerPullThroughRemote).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.RemotesPullThroughAPI.RemotesContainerPullThroughCreate(context.Background()).ContainerContainerPullThroughRemote(containerContainerPullThroughRemote).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
