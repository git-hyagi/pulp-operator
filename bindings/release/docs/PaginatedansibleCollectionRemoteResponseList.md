...
**Results** | [**[]AnsibleCollectionRemoteResponse**](AnsibleCollectionRemoteResponse.md) |  | 

## Methods

### NewPaginatedansibleCollectionRemoteResponseList

`func NewPaginatedansibleCollectionRemoteResponseList(count int32, results []AnsibleCollectionRemoteResponse, ) *PaginatedansibleCollectionRemoteResponseList`
