...
**DownloadCount** | Pointer to **int32** | Get the download count of the collection | [optional] [readonly] 
...
`func (o *CollectionResponse) GetDownloadCount() int32`

GetDownloadCount returns the DownloadCount field if non-nil, zero value otherwise.

### GetDownloadCountOk

`func (o *CollectionResponse) GetDownloadCountOk() (*int32, bool)`
...
`func (o *CollectionResponse) SetDownloadCount(v int32)`
