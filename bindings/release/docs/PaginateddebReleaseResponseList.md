...
**Results** | [**[]DebReleaseResponse**](DebReleaseResponse.md) |  | 

## Methods

### NewPaginateddebReleaseResponseList

`func NewPaginateddebReleaseResponseList(count int32, results []DebReleaseResponse, ) *PaginateddebReleaseResponseList`
