...
`func (o *OstreeOstreeSummaryResponse) GetVulnReport() string`

GetVulnReport returns the VulnReport field if non-nil, zero value otherwise.

### GetVulnReportOk

`func (o *OstreeOstreeSummaryResponse) GetVulnReportOk() (*string, bool)`
...
`func (o *OstreeOstreeSummaryResponse) SetVulnReport(v string)`

SetVulnReport sets VulnReport field to given value.

### HasVulnReport

`func (o *OstreeOstreeSummaryResponse) HasVulnReport() bool`
