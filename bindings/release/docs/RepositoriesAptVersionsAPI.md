...
> AsyncOperationResponse RepositoriesDebAptVersionsDelete(ctx, debAptRepositoryVersionHref).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	resp, r, err := apiClient.RepositoriesAptVersionsAPI.RepositoriesDebAptVersionsDelete(context.Background(), debAptRepositoryVersionHref).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.RepositoriesAptVersionsAPI.RepositoriesDebAptVersionsList(context.Background(), debAptRepositoryHref).XTaskDiagnostics(xTaskDiagnostics).Content(content).ContentIn(contentIn).Limit(limit).Number(number).NumberGt(numberGt).NumberGte(numberGte).NumberLt(numberLt).NumberLte(numberLte).NumberRange(numberRange).Offset(offset).Ordering(ordering).PrnIn(prnIn).PulpCreated(pulpCreated).PulpCreatedGt(pulpCreatedGt).PulpCreatedGte(pulpCreatedGte).PulpCreatedIsnull(pulpCreatedIsnull).PulpCreatedLt(pulpCreatedLt).PulpCreatedLte(pulpCreatedLte).PulpCreatedRange(pulpCreatedRange).PulpHrefIn(pulpHrefIn).Q(q).Fields(fields).ExcludeFields(excludeFields).Execute()
	if err != nil {
...
> RepositoryVersionResponse RepositoriesDebAptVersionsRead(ctx, debAptRepositoryVersionHref).XTaskDiagnostics(xTaskDiagnostics).Fields(fields).ExcludeFields(excludeFields).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.RepositoriesAptVersionsAPI.RepositoriesDebAptVersionsRead(context.Background(), debAptRepositoryVersionHref).XTaskDiagnostics(xTaskDiagnostics).Fields(fields).ExcludeFields(excludeFields).Execute()
	if err != nil {
...
> AsyncOperationResponse RepositoriesDebAptVersionsRepair(ctx, debAptRepositoryVersionHref).Repair(repair).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.RepositoriesAptVersionsAPI.RepositoriesDebAptVersionsRepair(context.Background(), debAptRepositoryVersionHref).Repair(repair).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
