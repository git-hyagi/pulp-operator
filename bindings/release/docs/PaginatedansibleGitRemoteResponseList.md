...
**Results** | [**[]AnsibleGitRemoteResponse**](AnsibleGitRemoteResponse.md) |  | 

## Methods

### NewPaginatedansibleGitRemoteResponseList

`func NewPaginatedansibleGitRemoteResponseList(count int32, results []AnsibleGitRemoteResponse, ) *PaginatedansibleGitRemoteResponseList`
