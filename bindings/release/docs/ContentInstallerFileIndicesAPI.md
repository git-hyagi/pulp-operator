...
------------- | ------------- | -------------
[**ContentDebInstallerFileIndicesCreate**](ContentInstallerFileIndicesAPI.md#ContentDebInstallerFileIndicesCreate) | **Post** /api/v3/content/deb/installer_file_indices/ | Create an installer file index
[**ContentDebInstallerFileIndicesList**](ContentInstallerFileIndicesAPI.md#ContentDebInstallerFileIndicesList) | **Get** /api/v3/content/deb/installer_file_indices/ | List InstallerFileIndices
...
[**ContentDebInstallerFileIndicesSetLabel**](ContentInstallerFileIndicesAPI.md#ContentDebInstallerFileIndicesSetLabel) | **Post** /{deb_installer_file_index_href}set_label/ | Set a label
[**ContentDebInstallerFileIndicesUnsetLabel**](ContentInstallerFileIndicesAPI.md#ContentDebInstallerFileIndicesUnsetLabel) | **Post** /{deb_installer_file_index_href}unset_label/ | Unset a label



## ContentDebInstallerFileIndicesCreate

> DebInstallerFileIndexResponse ContentDebInstallerFileIndicesCreate(ctx).DebInstallerFileIndex(debInstallerFileIndex).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	resp, r, err := apiClient.ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesCreate(context.Background()).DebInstallerFileIndex(debInstallerFileIndex).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesList(context.Background()).XTaskDiagnostics(xTaskDiagnostics).Architecture(architecture).Component(component).Limit(limit).Offset(offset).Ordering(ordering).OrphanedFor(orphanedFor).PrnIn(prnIn).PulpHrefIn(pulpHrefIn).PulpIdIn(pulpIdIn).PulpLabelSelect(pulpLabelSelect).Q(q).RelativePath(relativePath).RepositoryVersion(repositoryVersion).RepositoryVersionAdded(repositoryVersionAdded).RepositoryVersionRemoved(repositoryVersionRemoved).Sha256(sha256).Fields(fields).ExcludeFields(excludeFields).Execute()
	if err != nil {
...
> DebInstallerFileIndexResponse ContentDebInstallerFileIndicesRead(ctx, debInstallerFileIndexHref).XTaskDiagnostics(xTaskDiagnostics).Fields(fields).ExcludeFields(excludeFields).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesRead(context.Background(), debInstallerFileIndexHref).XTaskDiagnostics(xTaskDiagnostics).Fields(fields).ExcludeFields(excludeFields).Execute()
	if err != nil {
...
## ContentDebInstallerFileIndicesSetLabel

> SetLabelResponse ContentDebInstallerFileIndicesSetLabel(ctx, debInstallerFileIndexHref).SetLabel(setLabel).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesSetLabel(context.Background(), debInstallerFileIndexHref).SetLabel(setLabel).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesSetLabel``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ContentDebInstallerFileIndicesSetLabel`: SetLabelResponse
	fmt.Fprintf(os.Stdout, "Response from `ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesSetLabel`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiContentDebInstallerFileIndicesSetLabelRequest struct via the builder pattern
...
## ContentDebInstallerFileIndicesUnsetLabel

> UnsetLabelResponse ContentDebInstallerFileIndicesUnsetLabel(ctx, debInstallerFileIndexHref).UnsetLabel(unsetLabel).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesUnsetLabel(context.Background(), debInstallerFileIndexHref).UnsetLabel(unsetLabel).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesUnsetLabel``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ContentDebInstallerFileIndicesUnsetLabel`: UnsetLabelResponse
	fmt.Fprintf(os.Stdout, "Response from `ContentInstallerFileIndicesAPI.ContentDebInstallerFileIndicesUnsetLabel`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiContentDebInstallerFileIndicesUnsetLabelRequest struct via the builder pattern
