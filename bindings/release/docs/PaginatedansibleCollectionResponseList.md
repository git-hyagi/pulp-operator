...
**Results** | [**[]AnsibleCollectionResponse**](AnsibleCollectionResponse.md) |  | 

## Methods

### NewPaginatedansibleCollectionResponseList

`func NewPaginatedansibleCollectionResponseList(count int32, results []AnsibleCollectionResponse, ) *PaginatedansibleCollectionResponseList`
