...
`func NewCollectionVersionResponse(version string, createdAt time.Time, updatedAt time.Time, signatures []CollectionVersionSignatureResponse, ) *CollectionVersionResponse`
