...
> PulpAnsibleGalaxyDefaultApiGet(ctx).XTaskDiagnostics(xTaskDiagnostics).Fields(fields).ExcludeFields(excludeFields).Execute()
...
func main() {
	...
	r, err := apiClient.PulpAnsibleDefaultApiAPI.PulpAnsibleGalaxyDefaultApiGet(context.Background()).XTaskDiagnostics(xTaskDiagnostics).Fields(fields).ExcludeFields(excludeFields).Execute()
	if err != nil {
