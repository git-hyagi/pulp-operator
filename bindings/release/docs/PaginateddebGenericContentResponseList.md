...
**Results** | [**[]DebGenericContentResponse**](DebGenericContentResponse.md) |  | 

## Methods

### NewPaginateddebGenericContentResponseList

`func NewPaginateddebGenericContentResponseList(count int32, results []DebGenericContentResponse, ) *PaginateddebGenericContentResponseList`
