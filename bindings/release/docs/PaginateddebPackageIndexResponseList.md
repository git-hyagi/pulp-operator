...
**Results** | [**[]DebPackageIndexResponse**](DebPackageIndexResponse.md) |  | 

## Methods

### NewPaginateddebPackageIndexResponseList

`func NewPaginateddebPackageIndexResponseList(count int32, results []DebPackageIndexResponse, ) *PaginateddebPackageIndexResponseList`
