...
`func (o *PulpImporterResponse) GetPrn() string`

GetPrn returns the Prn field if non-nil, zero value otherwise.

### GetPrnOk

`func (o *PulpImporterResponse) GetPrnOk() (*string, bool)`
...
`func (o *PulpImporterResponse) SetPrn(v string)`

SetPrn sets Prn field to given value.

### HasPrn

`func (o *PulpImporterResponse) HasPrn() bool`
