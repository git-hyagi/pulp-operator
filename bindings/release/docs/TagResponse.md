...
**Count** | Pointer to **int64** |  | [optional] [readonly] 
...
`func (o *TagResponse) GetCount() int64`

GetCount returns the Count field if non-nil, zero value otherwise.

### GetCountOk

`func (o *TagResponse) GetCountOk() (*int64, bool)`
...
`func (o *TagResponse) SetCount(v int64)`

SetCount sets Count field to given value.

### HasCount

`func (o *TagResponse) HasCount() bool`
