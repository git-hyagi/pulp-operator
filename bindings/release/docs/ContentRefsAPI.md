...
> OstreeOstreeRefResponse ContentOstreeRefsRead(ctx, ostreeOstreeRefHref).XTaskDiagnostics(xTaskDiagnostics).Fields(fields).ExcludeFields(excludeFields).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentRefsAPI.ContentOstreeRefsRead(context.Background(), ostreeOstreeRefHref).XTaskDiagnostics(xTaskDiagnostics).Fields(fields).ExcludeFields(excludeFields).Execute()
	if err != nil {
...
## ContentOstreeRefsSetLabel

> SetLabelResponse ContentOstreeRefsSetLabel(ctx, ostreeOstreeRefHref).SetLabel(setLabel).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentRefsAPI.ContentOstreeRefsSetLabel(context.Background(), ostreeOstreeRefHref).SetLabel(setLabel).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ContentRefsAPI.ContentOstreeRefsSetLabel``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ContentOstreeRefsSetLabel`: SetLabelResponse
	fmt.Fprintf(os.Stdout, "Response from `ContentRefsAPI.ContentOstreeRefsSetLabel`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiContentOstreeRefsSetLabelRequest struct via the builder pattern
...
## ContentOstreeRefsUnsetLabel

> UnsetLabelResponse ContentOstreeRefsUnsetLabel(ctx, ostreeOstreeRefHref).UnsetLabel(unsetLabel).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ContentRefsAPI.ContentOstreeRefsUnsetLabel(context.Background(), ostreeOstreeRefHref).UnsetLabel(unsetLabel).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ContentRefsAPI.ContentOstreeRefsUnsetLabel``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ContentOstreeRefsUnsetLabel`: UnsetLabelResponse
	fmt.Fprintf(os.Stdout, "Response from `ContentRefsAPI.ContentOstreeRefsUnsetLabel`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiContentOstreeRefsUnsetLabelRequest struct via the builder pattern
