...
**Results** | [**[]AnsibleAnsibleRepositoryResponse**](AnsibleAnsibleRepositoryResponse.md) |  | 

## Methods

### NewPaginatedansibleAnsibleRepositoryResponseList

`func NewPaginatedansibleAnsibleRepositoryResponseList(count int32, results []AnsibleAnsibleRepositoryResponse, ) *PaginatedansibleAnsibleRepositoryResponseList`
