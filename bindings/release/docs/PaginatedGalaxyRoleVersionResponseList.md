...
**Results** | [**[]GalaxyRoleVersionResponse**](GalaxyRoleVersionResponse.md) |  | 

## Methods

### NewPaginatedGalaxyRoleVersionResponseList

`func NewPaginatedGalaxyRoleVersionResponseList(count int32, results []GalaxyRoleVersionResponse, ) *PaginatedGalaxyRoleVersionResponseList`
