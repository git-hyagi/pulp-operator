...
**SyncDependencies** | Pointer to **bool** | Sync dependencies for collections specified via requirements file | [optional] 
**SignedOnly** | Pointer to **bool** | Sync only collections that have a signature | [optional] 
**LastSyncTask** | Pointer to **string** |  | [optional] [readonly] 
...
`func (o *AnsibleCollectionRemoteResponse) GetPrn() string`

GetPrn returns the Prn field if non-nil, zero value otherwise.

### GetPrnOk

`func (o *AnsibleCollectionRemoteResponse) GetPrnOk() (*string, bool)`
...
`func (o *AnsibleCollectionRemoteResponse) SetPrn(v string)`

SetPrn sets Prn field to given value.

### HasPrn

`func (o *AnsibleCollectionRemoteResponse) HasPrn() bool`
...
`func (o *AnsibleCollectionRemoteResponse) GetPolicy() PolicyB5fEnum`

GetPolicy returns the Policy field if non-nil, zero value otherwise.

### GetPolicyOk

`func (o *AnsibleCollectionRemoteResponse) GetPolicyOk() (*PolicyB5fEnum, bool)`
...
`func (o *AnsibleCollectionRemoteResponse) SetPolicy(v PolicyB5fEnum)`
...
`func (o *AnsibleCollectionRemoteResponse) GetHiddenFields() []GenericRemoteResponseHiddenFieldsInner`

GetHiddenFields returns the HiddenFields field if non-nil, zero value otherwise.

### GetHiddenFieldsOk

`func (o *AnsibleCollectionRemoteResponse) GetHiddenFieldsOk() (*[]GenericRemoteResponseHiddenFieldsInner, bool)`
...
`func (o *AnsibleCollectionRemoteResponse) SetHiddenFields(v []GenericRemoteResponseHiddenFieldsInner)`
...
`func (o *AnsibleCollectionRemoteResponse) GetLastSyncTask() string`

GetLastSyncTask returns the LastSyncTask field if non-nil, zero value otherwise.

### GetLastSyncTaskOk

`func (o *AnsibleCollectionRemoteResponse) GetLastSyncTaskOk() (*string, bool)`
...
`func (o *AnsibleCollectionRemoteResponse) SetLastSyncTask(v string)`
