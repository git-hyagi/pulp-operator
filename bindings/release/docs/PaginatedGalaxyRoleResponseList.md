...
**Results** | [**[]GalaxyRoleResponse**](GalaxyRoleResponse.md) |  | 

## Methods

### NewPaginatedGalaxyRoleResponseList

`func NewPaginatedGalaxyRoleResponseList(count int32, results []GalaxyRoleResponse, ) *PaginatedGalaxyRoleResponseList`
