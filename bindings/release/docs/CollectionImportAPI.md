...
> CollectionImportDetailResponse CollectionImportRead(ctx, ansibleCollectionImportHref).XTaskDiagnostics(xTaskDiagnostics).Since(since).Fields(fields).ExcludeFields(excludeFields).Execute()
...
func main() {
	...
	resp, r, err := apiClient.CollectionImportAPI.CollectionImportRead(context.Background(), ansibleCollectionImportHref).XTaskDiagnostics(xTaskDiagnostics).Since(since).Fields(fields).ExcludeFields(excludeFields).Execute()
	if err != nil {
