...
`func (o *UploadDetailResponse) GetPrn() string`

GetPrn returns the Prn field if non-nil, zero value otherwise.

### GetPrnOk

`func (o *UploadDetailResponse) GetPrnOk() (*string, bool)`
...
`func (o *UploadDetailResponse) SetPrn(v string)`

SetPrn sets Prn field to given value.

### HasPrn

`func (o *UploadDetailResponse) HasPrn() bool`
