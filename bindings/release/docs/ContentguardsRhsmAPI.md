...
------------- | ------------- | -------------
[**ContentguardsCertguardRhsmCreate**](ContentguardsRhsmAPI.md#ContentguardsCertguardRhsmCreate) | **Post** /api/v3/contentguards/certguard/rhsm/ | Create a rhsm cert guard
...
[**ContentguardsCertguardRhsmList**](ContentguardsRhsmAPI.md#ContentguardsCertguardRhsmList) | **Get** /api/v3/contentguards/certguard/rhsm/ | List rhsm cert guards
...
> CertguardRHSMCertGuardResponse ContentguardsCertguardRhsmCreate(ctx).CertguardRHSMCertGuard(certguardRHSMCertGuard).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	resp, r, err := apiClient.ContentguardsRhsmAPI.ContentguardsCertguardRhsmCreate(context.Background()).CertguardRHSMCertGuard(certguardRHSMCertGuard).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
