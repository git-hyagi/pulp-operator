...
**Results** | [**[]DebReleaseFileResponse**](DebReleaseFileResponse.md) |  | 

## Methods

### NewPaginateddebReleaseFileResponseList

`func NewPaginateddebReleaseFileResponseList(count int32, results []DebReleaseFileResponse, ) *PaginateddebReleaseFileResponseList`
