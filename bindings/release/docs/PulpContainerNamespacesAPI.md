...
[**PulpContainerNamespacesCreate**](PulpContainerNamespacesAPI.md#PulpContainerNamespacesCreate) | **Post** /api/v3/pulp_container/namespaces/ | Create a container namespace
...
[**PulpContainerNamespacesList**](PulpContainerNamespacesAPI.md#PulpContainerNamespacesList) | **Get** /api/v3/pulp_container/namespaces/ | List container namespaces
...
> ContainerContainerNamespaceResponse PulpContainerNamespacesCreate(ctx).ContainerContainerNamespace(containerContainerNamespace).XTaskDiagnostics(xTaskDiagnostics).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PulpContainerNamespacesAPI.PulpContainerNamespacesCreate(context.Background()).ContainerContainerNamespace(containerContainerNamespace).XTaskDiagnostics(xTaskDiagnostics).Execute()
	if err != nil {
