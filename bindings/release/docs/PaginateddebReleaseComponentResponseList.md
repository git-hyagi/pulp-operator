...
**Results** | [**[]DebReleaseComponentResponse**](DebReleaseComponentResponse.md) |  | 

## Methods

### NewPaginateddebReleaseComponentResponseList

`func NewPaginateddebReleaseComponentResponseList(count int32, results []DebReleaseComponentResponse, ) *PaginateddebReleaseComponentResponseList`
