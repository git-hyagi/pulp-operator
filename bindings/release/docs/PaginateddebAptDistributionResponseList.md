...
**Results** | [**[]DebAptDistributionResponse**](DebAptDistributionResponse.md) |  | 

## Methods

### NewPaginateddebAptDistributionResponseList

`func NewPaginateddebAptDistributionResponseList(count int32, results []DebAptDistributionResponse, ) *PaginateddebAptDistributionResponseList`
