...
func Test_pulpbindings_ContentReleaseArchitecturesAPIService(t *testing.T) {
	...
	t.Run("Test ContentReleaseArchitecturesAPIService ContentDebReleaseArchitecturesSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debReleaseArchitectureHref string

		resp, httpRes, err := apiClient.ContentReleaseArchitecturesAPI.ContentDebReleaseArchitecturesSetLabel(context.Background(), debReleaseArchitectureHref).Execute()
	...
	t.Run("Test ContentReleaseArchitecturesAPIService ContentDebReleaseArchitecturesUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debReleaseArchitectureHref string

		resp, httpRes, err := apiClient.ContentReleaseArchitecturesAPI.ContentDebReleaseArchitecturesUnsetLabel(context.Background(), debReleaseArchitectureHref).Execute()
