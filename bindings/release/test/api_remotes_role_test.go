...
func Test_pulpbindings_RemotesRoleAPIService(t *testing.T) {
	...
	t.Run("Test RemotesRoleAPIService RemotesAnsibleRoleSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleRoleRemoteHref string

		resp, httpRes, err := apiClient.RemotesRoleAPI.RemotesAnsibleRoleSetLabel(context.Background(), ansibleRoleRemoteHref).Execute()
	...
	t.Run("Test RemotesRoleAPIService RemotesAnsibleRoleUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleRoleRemoteHref string

		resp, httpRes, err := apiClient.RemotesRoleAPI.RemotesAnsibleRoleUnsetLabel(context.Background(), ansibleRoleRemoteHref).Execute()
