...
func Test_pulpbindings_RepositoriesAnsibleAPIService(t *testing.T) {
	...
	t.Run("Test RepositoriesAnsibleAPIService RepositoriesAnsibleAnsibleSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleAnsibleRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesAnsibleAPI.RepositoriesAnsibleAnsibleSetLabel(context.Background(), ansibleAnsibleRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesAnsibleAPIService RepositoriesAnsibleAnsibleUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleAnsibleRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesAnsibleAPI.RepositoriesAnsibleAnsibleUnsetLabel(context.Background(), ansibleAnsibleRepositoryHref).Execute()
