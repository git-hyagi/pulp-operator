...
func Test_pulpbindings_RemotesGitAPIService(t *testing.T) {
	...
	t.Run("Test RemotesGitAPIService RemotesAnsibleGitSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleGitRemoteHref string

		resp, httpRes, err := apiClient.RemotesGitAPI.RemotesAnsibleGitSetLabel(context.Background(), ansibleGitRemoteHref).Execute()
	...
	t.Run("Test RemotesGitAPIService RemotesAnsibleGitUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleGitRemoteHref string

		resp, httpRes, err := apiClient.RemotesGitAPI.RemotesAnsibleGitUnsetLabel(context.Background(), ansibleGitRemoteHref).Execute()
