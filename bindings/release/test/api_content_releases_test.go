...
func Test_pulpbindings_ContentReleasesAPIService(t *testing.T) {
	...
	t.Run("Test ContentReleasesAPIService ContentDebReleasesSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debReleaseHref string

		resp, httpRes, err := apiClient.ContentReleasesAPI.ContentDebReleasesSetLabel(context.Background(), debReleaseHref).Execute()
	...
	t.Run("Test ContentReleasesAPIService ContentDebReleasesUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debReleaseHref string

		resp, httpRes, err := apiClient.ContentReleasesAPI.ContentDebReleasesUnsetLabel(context.Background(), debReleaseHref).Execute()
