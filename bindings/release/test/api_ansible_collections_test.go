...
func Test_pulpbindings_AnsibleCollectionsAPIService(t *testing.T) {
	...
	t.Run("Test AnsibleCollectionsAPIService AnsibleCollectionsRead", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionHref string

		resp, httpRes, err := apiClient.AnsibleCollectionsAPI.AnsibleCollectionsRead(context.Background(), ansibleCollectionHref).Execute()
