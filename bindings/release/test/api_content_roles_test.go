...
func Test_pulpbindings_ContentRolesAPIService(t *testing.T) {
	...
	t.Run("Test ContentRolesAPIService ContentAnsibleRolesSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleRoleHref string

		resp, httpRes, err := apiClient.ContentRolesAPI.ContentAnsibleRolesSetLabel(context.Background(), ansibleRoleHref).Execute()
	...
	t.Run("Test ContentRolesAPIService ContentAnsibleRolesUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleRoleHref string

		resp, httpRes, err := apiClient.ContentRolesAPI.ContentAnsibleRolesUnsetLabel(context.Background(), ansibleRoleHref).Execute()
