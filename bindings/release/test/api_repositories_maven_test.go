...
func Test_pulpbindings_RepositoriesMavenAPIService(t *testing.T) {
	...
	t.Run("Test RepositoriesMavenAPIService RepositoriesMavenMavenSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var mavenMavenRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesMavenAPI.RepositoriesMavenMavenSetLabel(context.Background(), mavenMavenRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesMavenAPIService RepositoriesMavenMavenUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var mavenMavenRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesMavenAPI.RepositoriesMavenMavenUnsetLabel(context.Background(), mavenMavenRepositoryHref).Execute()
