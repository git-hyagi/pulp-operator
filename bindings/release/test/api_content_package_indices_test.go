...
func Test_pulpbindings_ContentPackageIndicesAPIService(t *testing.T) {
	...
	t.Run("Test ContentPackageIndicesAPIService ContentDebPackageIndicesSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debPackageIndexHref string

		resp, httpRes, err := apiClient.ContentPackageIndicesAPI.ContentDebPackageIndicesSetLabel(context.Background(), debPackageIndexHref).Execute()
	...
	t.Run("Test ContentPackageIndicesAPIService ContentDebPackageIndicesUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debPackageIndexHref string

		resp, httpRes, err := apiClient.ContentPackageIndicesAPI.ContentDebPackageIndicesUnsetLabel(context.Background(), debPackageIndexHref).Execute()
