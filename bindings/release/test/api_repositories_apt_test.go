...
func Test_pulpbindings_RepositoriesAptAPIService(t *testing.T) {

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)

	t.Run("Test RepositoriesAptAPIService RepositoriesDebAptAddRole", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debAptRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesAptAPI.RepositoriesDebAptAddRole(context.Background(), debAptRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesAptAPIService RepositoriesDebAptListRoles", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debAptRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesAptAPI.RepositoriesDebAptListRoles(context.Background(), debAptRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesAptAPIService RepositoriesDebAptMyPermissions", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debAptRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesAptAPI.RepositoriesDebAptMyPermissions(context.Background(), debAptRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesAptAPIService RepositoriesDebAptRemoveRole", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debAptRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesAptAPI.RepositoriesDebAptRemoveRole(context.Background(), debAptRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesAptAPIService RepositoriesDebAptSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debAptRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesAptAPI.RepositoriesDebAptSetLabel(context.Background(), debAptRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesAptAPIService RepositoriesDebAptUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debAptRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesAptAPI.RepositoriesDebAptUnsetLabel(context.Background(), debAptRepositoryHref).Execute()
