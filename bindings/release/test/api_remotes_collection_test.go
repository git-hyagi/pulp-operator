...
func Test_pulpbindings_RemotesCollectionAPIService(t *testing.T) {
	...
	t.Run("Test RemotesCollectionAPIService RemotesAnsibleCollectionSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionRemoteHref string

		resp, httpRes, err := apiClient.RemotesCollectionAPI.RemotesAnsibleCollectionSetLabel(context.Background(), ansibleCollectionRemoteHref).Execute()
	...
	t.Run("Test RemotesCollectionAPIService RemotesAnsibleCollectionUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionRemoteHref string

		resp, httpRes, err := apiClient.RemotesCollectionAPI.RemotesAnsibleCollectionUnsetLabel(context.Background(), ansibleCollectionRemoteHref).Execute()
