...
func Test_pulpbindings_ContentPackageReleaseComponentsAPIService(t *testing.T) {
	...
	t.Run("Test ContentPackageReleaseComponentsAPIService ContentDebPackageReleaseComponentsSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debPackageReleaseComponentHref string

		resp, httpRes, err := apiClient.ContentPackageReleaseComponentsAPI.ContentDebPackageReleaseComponentsSetLabel(context.Background(), debPackageReleaseComponentHref).Execute()
	...
	t.Run("Test ContentPackageReleaseComponentsAPIService ContentDebPackageReleaseComponentsUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debPackageReleaseComponentHref string

		resp, httpRes, err := apiClient.ContentPackageReleaseComponentsAPI.ContentDebPackageReleaseComponentsUnsetLabel(context.Background(), debPackageReleaseComponentHref).Execute()
