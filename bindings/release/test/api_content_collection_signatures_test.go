...
func Test_pulpbindings_ContentCollectionSignaturesAPIService(t *testing.T) {
	...
	t.Run("Test ContentCollectionSignaturesAPIService ContentAnsibleCollectionSignaturesSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionVersionSignatureHref string

		resp, httpRes, err := apiClient.ContentCollectionSignaturesAPI.ContentAnsibleCollectionSignaturesSetLabel(context.Background(), ansibleCollectionVersionSignatureHref).Execute()
	...
	t.Run("Test ContentCollectionSignaturesAPIService ContentAnsibleCollectionSignaturesUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionVersionSignatureHref string

		resp, httpRes, err := apiClient.ContentCollectionSignaturesAPI.ContentAnsibleCollectionSignaturesUnsetLabel(context.Background(), ansibleCollectionVersionSignatureHref).Execute()
