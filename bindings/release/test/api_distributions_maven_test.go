...
func Test_pulpbindings_DistributionsMavenAPIService(t *testing.T) {
	...
	t.Run("Test DistributionsMavenAPIService DistributionsMavenMavenSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var mavenMavenDistributionHref string

		resp, httpRes, err := apiClient.DistributionsMavenAPI.DistributionsMavenMavenSetLabel(context.Background(), mavenMavenDistributionHref).Execute()
	...
	t.Run("Test DistributionsMavenAPIService DistributionsMavenMavenUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var mavenMavenDistributionHref string

		resp, httpRes, err := apiClient.DistributionsMavenAPI.DistributionsMavenMavenUnsetLabel(context.Background(), mavenMavenDistributionHref).Execute()
