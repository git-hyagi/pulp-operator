...
func Test_pulpbindings_RepositoriesContainerAPIService(t *testing.T) {
	...
	t.Run("Test RepositoriesContainerAPIService RepositoriesContainerContainerSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var containerContainerRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesContainerAPI.RepositoriesContainerContainerSetLabel(context.Background(), containerContainerRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesContainerAPIService RepositoriesContainerContainerUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var containerContainerRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesContainerAPI.RepositoriesContainerContainerUnsetLabel(context.Background(), containerContainerRepositoryHref).Execute()
