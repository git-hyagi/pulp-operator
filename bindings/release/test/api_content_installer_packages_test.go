...
func Test_pulpbindings_ContentInstallerPackagesAPIService(t *testing.T) {
	...
	t.Run("Test ContentInstallerPackagesAPIService ContentDebInstallerPackagesSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debInstallerPackageHref string

		resp, httpRes, err := apiClient.ContentInstallerPackagesAPI.ContentDebInstallerPackagesSetLabel(context.Background(), debInstallerPackageHref).Execute()
	...
	t.Run("Test ContentInstallerPackagesAPIService ContentDebInstallerPackagesUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var debInstallerPackageHref string

		resp, httpRes, err := apiClient.ContentInstallerPackagesAPI.ContentDebInstallerPackagesUnsetLabel(context.Background(), debInstallerPackageHref).Execute()
