...
func Test_pulpbindings_ContentCollectionVersionsAPIService(t *testing.T) {
	...
	t.Run("Test ContentCollectionVersionsAPIService ContentAnsibleCollectionVersionsSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionVersionHref string

		resp, httpRes, err := apiClient.ContentCollectionVersionsAPI.ContentAnsibleCollectionVersionsSetLabel(context.Background(), ansibleCollectionVersionHref).Execute()
	...
	t.Run("Test ContentCollectionVersionsAPIService ContentAnsibleCollectionVersionsUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionVersionHref string

		resp, httpRes, err := apiClient.ContentCollectionVersionsAPI.ContentAnsibleCollectionVersionsUnsetLabel(context.Background(), ansibleCollectionVersionHref).Execute()
