...
func Test_pulpbindings_RepositoriesPythonAPIService(t *testing.T) {

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)

	t.Run("Test RepositoriesPythonAPIService RepositoriesPythonPythonAddRole", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var pythonPythonRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesPythonAPI.RepositoriesPythonPythonAddRole(context.Background(), pythonPythonRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesPythonAPIService RepositoriesPythonPythonListRoles", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var pythonPythonRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesPythonAPI.RepositoriesPythonPythonListRoles(context.Background(), pythonPythonRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesPythonAPIService RepositoriesPythonPythonMyPermissions", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var pythonPythonRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesPythonAPI.RepositoriesPythonPythonMyPermissions(context.Background(), pythonPythonRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesPythonAPIService RepositoriesPythonPythonRemoveRole", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var pythonPythonRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesPythonAPI.RepositoriesPythonPythonRemoveRole(context.Background(), pythonPythonRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesPythonAPIService RepositoriesPythonPythonSetLabel", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoriesPythonAPI.RepositoriesPythonPythonSetLabel(context.Background(), pythonPythonRepositoryHref).Execute()
	...
	t.Run("Test RepositoriesPythonAPIService RepositoriesPythonPythonUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var pythonPythonRepositoryHref string

		resp, httpRes, err := apiClient.RepositoriesPythonAPI.RepositoriesPythonPythonUnsetLabel(context.Background(), pythonPythonRepositoryHref).Execute()
