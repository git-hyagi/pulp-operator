...
func Test_pulpbindings_DistributionsAnsibleAPIService(t *testing.T) {
	...
	t.Run("Test DistributionsAnsibleAPIService DistributionsAnsibleAnsibleSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleAnsibleDistributionHref string

		resp, httpRes, err := apiClient.DistributionsAnsibleAPI.DistributionsAnsibleAnsibleSetLabel(context.Background(), ansibleAnsibleDistributionHref).Execute()
	...
	t.Run("Test DistributionsAnsibleAPIService DistributionsAnsibleAnsibleUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleAnsibleDistributionHref string

		resp, httpRes, err := apiClient.DistributionsAnsibleAPI.DistributionsAnsibleAnsibleUnsetLabel(context.Background(), ansibleAnsibleDistributionHref).Execute()
