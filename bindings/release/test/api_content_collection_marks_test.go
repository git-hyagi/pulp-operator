...
func Test_pulpbindings_ContentCollectionMarksAPIService(t *testing.T) {
	...
	t.Run("Test ContentCollectionMarksAPIService ContentAnsibleCollectionMarksSetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionVersionMarkHref string

		resp, httpRes, err := apiClient.ContentCollectionMarksAPI.ContentAnsibleCollectionMarksSetLabel(context.Background(), ansibleCollectionVersionMarkHref).Execute()
	...
	t.Run("Test ContentCollectionMarksAPIService ContentAnsibleCollectionMarksUnsetLabel", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var ansibleCollectionVersionMarkHref string

		resp, httpRes, err := apiClient.ContentCollectionMarksAPI.ContentAnsibleCollectionMarksUnsetLabel(context.Background(), ansibleCollectionVersionMarkHref).Execute()
