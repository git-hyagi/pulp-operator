...
func (r RemotesCollectionAPIRemotesAnsibleCollectionAddRoleRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionAddRoleRequest {
...
/*
RemotesAnsibleCollectionAddRole Add a role
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionCreateRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionCreateRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
func (a *RemotesCollectionAPIService) RemotesAnsibleCollectionCreateExecute(r RemotesCollectionAPIRemotesAnsibleCollectionCreateRequest) (*AnsibleCollectionRemoteResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/remotes/ansible/collection/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionDeleteRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionDeleteRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionListRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
// Filter results where name matches value
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) NameIexact(nameIexact string) RemotesCollectionAPIRemotesAnsibleCollectionListRequest {
...
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) NameIregex(nameIregex string) RemotesCollectionAPIRemotesAnsibleCollectionListRequest {
	r.nameIregex = &nameIregex
	return r
}

// Filter results where name starts with value
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) NameIstartswith(nameIstartswith string) RemotesCollectionAPIRemotesAnsibleCollectionListRequest {
	r.nameIstartswith = &nameIstartswith
	return r
}

// Filter results where name matches regex value
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) NameRegex(nameRegex string) RemotesCollectionAPIRemotesAnsibleCollectionListRequest {
...
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) PrnIn(prnIn []string) RemotesCollectionAPIRemotesAnsibleCollectionListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) PulpLastUpdatedIsnull(pulpLastUpdatedIsnull bool) RemotesCollectionAPIRemotesAnsibleCollectionListRequest {
...
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) Q(q string) RemotesCollectionAPIRemotesAnsibleCollectionListRequest {
	r.q = &q
	return r
}
...
func (a *RemotesCollectionAPIService) RemotesAnsibleCollectionListExecute(r RemotesCollectionAPIRemotesAnsibleCollectionListRequest) (*PaginatedansibleCollectionRemoteResponseList, *http.Response, error) {
	...
	if r.urlContains != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "url__contains", r.urlContains, "form", "")
	}
	if r.urlIcontains != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "url__icontains", r.urlIcontains, "form", "")
	}
	if r.urlIn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "url__in", r.urlIn, "form", "csv")
	}
	if r.fields != nil {
		t := *r.fields
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionListRolesRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionListRolesRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
/*
RemotesAnsibleCollectionListRoles List roles
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionMyPermissionsRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionMyPermissionsRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
/*
RemotesAnsibleCollectionMyPermissions List user permissions
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionPartialUpdateRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionPartialUpdateRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r RemotesCollectionAPIRemotesAnsibleCollectionPartialUpdateRequest) Execute() (*AnsibleCollectionRemoteResponse, *http.Response, error) {
...
// Execute executes the request
//  @return AnsibleCollectionRemoteResponse
func (a *RemotesCollectionAPIService) RemotesAnsibleCollectionPartialUpdateExecute(r RemotesCollectionAPIRemotesAnsibleCollectionPartialUpdateRequest) (*AnsibleCollectionRemoteResponse, *http.Response, error) {
	var (
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionReadRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionReadRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionRemoveRoleRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionRemoveRoleRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
/*
RemotesAnsibleCollectionRemoveRole Remove a role
...
type RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest struct {
	ctx context.Context
	ApiService *RemotesCollectionAPIService
	ansibleCollectionRemoteHref string
	setLabel *SetLabel
...
func (r RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest) SetLabel(setLabel SetLabel) RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest {
	r.setLabel = &setLabel
	return r
}

// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest) Execute() (*SetLabelResponse, *http.Response, error) {
	return r.ApiService.RemotesAnsibleCollectionSetLabelExecute(r)
}

/*
RemotesAnsibleCollectionSetLabel Set a label

Set a single pulp_label on the object to a specific value or null.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ansibleCollectionRemoteHref
 @return RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest
*/
func (a *RemotesCollectionAPIService) RemotesAnsibleCollectionSetLabel(ctx context.Context, ansibleCollectionRemoteHref string) RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest {
	return RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest{
		ApiService: a,
		ctx: ctx,
		ansibleCollectionRemoteHref: ansibleCollectionRemoteHref,
...
func (a *RemotesCollectionAPIService) RemotesAnsibleCollectionSetLabelExecute(r RemotesCollectionAPIRemotesAnsibleCollectionSetLabelRequest) (*SetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RemotesCollectionAPIService.RemotesAnsibleCollectionSetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{ansible_collection_remote_href}set_label/"
	localVarPath = strings.Replace(localVarPath, "{"+"ansible_collection_remote_href"+"}", url.PathEscape(parameterValueToString(r.ansibleCollectionRemoteHref, "ansibleCollectionRemoteHref")), -1)
        localVarPath = strings.Replace(localVarPath, "/%2F", "/", -1)
...
type RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest struct {
	ctx context.Context
	ApiService *RemotesCollectionAPIService
	ansibleCollectionRemoteHref string
...
func (r RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest) UnsetLabel(unsetLabel UnsetLabel) RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest {
	r.unsetLabel = &unsetLabel
	return r
}

// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest) Execute() (*UnsetLabelResponse, *http.Response, error) {
	return r.ApiService.RemotesAnsibleCollectionUnsetLabelExecute(r)
}

/*
RemotesAnsibleCollectionUnsetLabel Unset a label

Unset a single pulp_label on the object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ansibleCollectionRemoteHref
 @return RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest
*/
func (a *RemotesCollectionAPIService) RemotesAnsibleCollectionUnsetLabel(ctx context.Context, ansibleCollectionRemoteHref string) RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest {
	return RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest{
		ApiService: a,
		ctx: ctx,
		ansibleCollectionRemoteHref: ansibleCollectionRemoteHref,
...
func (a *RemotesCollectionAPIService) RemotesAnsibleCollectionUnsetLabelExecute(r RemotesCollectionAPIRemotesAnsibleCollectionUnsetLabelRequest) (*UnsetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RemotesCollectionAPIService.RemotesAnsibleCollectionUnsetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{ansible_collection_remote_href}unset_label/"
	localVarPath = strings.Replace(localVarPath, "{"+"ansible_collection_remote_href"+"}", url.PathEscape(parameterValueToString(r.ansibleCollectionRemoteHref, "ansibleCollectionRemoteHref")), -1)
        localVarPath = strings.Replace(localVarPath, "/%2F", "/", -1)
...
// List of profilers to use on tasks.
func (r RemotesCollectionAPIRemotesAnsibleCollectionUpdateRequest) XTaskDiagnostics(xTaskDiagnostics []string) RemotesCollectionAPIRemotesAnsibleCollectionUpdateRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r RemotesCollectionAPIRemotesAnsibleCollectionUpdateRequest) Execute() (*AnsibleCollectionRemoteResponse, *http.Response, error) {
...
// Execute executes the request
//  @return AnsibleCollectionRemoteResponse
func (a *RemotesCollectionAPIService) RemotesAnsibleCollectionUpdateExecute(r RemotesCollectionAPIRemotesAnsibleCollectionUpdateRequest) (*AnsibleCollectionRemoteResponse, *http.Response, error) {
	var (
