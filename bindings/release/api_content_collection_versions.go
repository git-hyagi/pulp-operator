...
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsCreateRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsCreateRequest {
...
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsCreateRequest) PulpLabels(pulpLabels map[string]string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsCreateRequest {
...
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsCreateRequest) FileUrl(fileUrl string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsCreateRequest {
	r.fileUrl = &fileUrl
	return r
}
...
func (a *ContentCollectionVersionsAPIService) ContentAnsibleCollectionVersionsCreateExecute(r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsCreateRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/content/ansible/collection_versions/"
...
// List of profilers to use on tasks.
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsListRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsListRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsListRequest) OrphanedFor(orphanedFor float32) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsListRequest {
	r.orphanedFor = &orphanedFor
	return r
}

// Multiple values may be separated by commas.
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsListRequest) PrnIn(prnIn []string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsListRequest) PulpLabelSelect(pulpLabelSelect string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsListRequest {
...
// List of profilers to use on tasks.
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsReadRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsReadRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
type ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest struct {
	ctx context.Context
	ApiService *ContentCollectionVersionsAPIService
	ansibleCollectionVersionHref string
	setLabel *SetLabel
...
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest) SetLabel(setLabel SetLabel) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest {
	r.setLabel = &setLabel
	return r
}

// List of profilers to use on tasks.
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest) Execute() (*SetLabelResponse, *http.Response, error) {
	return r.ApiService.ContentAnsibleCollectionVersionsSetLabelExecute(r)
}

/*
ContentAnsibleCollectionVersionsSetLabel Set a label

Set a single pulp_label on the object to a specific value or null.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ansibleCollectionVersionHref
 @return ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest
*/
func (a *ContentCollectionVersionsAPIService) ContentAnsibleCollectionVersionsSetLabel(ctx context.Context, ansibleCollectionVersionHref string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest {
	return ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest{
		ApiService: a,
		ctx: ctx,
		ansibleCollectionVersionHref: ansibleCollectionVersionHref,
...
func (a *ContentCollectionVersionsAPIService) ContentAnsibleCollectionVersionsSetLabelExecute(r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsSetLabelRequest) (*SetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContentCollectionVersionsAPIService.ContentAnsibleCollectionVersionsSetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{ansible_collection_version_href}set_label/"
	localVarPath = strings.Replace(localVarPath, "{"+"ansible_collection_version_href"+"}", url.PathEscape(parameterValueToString(r.ansibleCollectionVersionHref, "ansibleCollectionVersionHref")), -1)
        localVarPath = strings.Replace(localVarPath, "/%2F", "/", -1)
...
type ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest struct {
	ctx context.Context
	ApiService *ContentCollectionVersionsAPIService
	ansibleCollectionVersionHref string
...
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest) UnsetLabel(unsetLabel UnsetLabel) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest {
	r.unsetLabel = &unsetLabel
	return r
}

// List of profilers to use on tasks.
func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest) Execute() (*UnsetLabelResponse, *http.Response, error) {
	return r.ApiService.ContentAnsibleCollectionVersionsUnsetLabelExecute(r)
}

/*
ContentAnsibleCollectionVersionsUnsetLabel Unset a label

Unset a single pulp_label on the object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ansibleCollectionVersionHref
 @return ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest
*/
func (a *ContentCollectionVersionsAPIService) ContentAnsibleCollectionVersionsUnsetLabel(ctx context.Context, ansibleCollectionVersionHref string) ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest {
	return ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest{
		ApiService: a,
		ctx: ctx,
		ansibleCollectionVersionHref: ansibleCollectionVersionHref,
...
func (a *ContentCollectionVersionsAPIService) ContentAnsibleCollectionVersionsUnsetLabelExecute(r ContentCollectionVersionsAPIContentAnsibleCollectionVersionsUnsetLabelRequest) (*UnsetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContentCollectionVersionsAPIService.ContentAnsibleCollectionVersionsUnsetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{ansible_collection_version_href}unset_label/"
	localVarPath = strings.Replace(localVarPath, "{"+"ansible_collection_version_href"+"}", url.PathEscape(parameterValueToString(r.ansibleCollectionVersionHref, "ansibleCollectionVersionHref")), -1)
        localVarPath = strings.Replace(localVarPath, "/%2F", "/", -1)
