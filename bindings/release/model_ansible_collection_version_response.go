...
type AnsibleCollectionVersionResponse struct {
	...
	Tags []CollectionSummaryResponseTagsInner `json:"tags,omitempty"`
...
func (o *AnsibleCollectionVersionResponse) GetTags() []CollectionSummaryResponseTagsInner {
	if o == nil || IsNil(o.Tags) {
		var ret []CollectionSummaryResponseTagsInner
		return ret
	}
	return o.Tags
}
...
// SetTags gets a reference to the given []CollectionSummaryResponseTagsInner and assigns it to the Tags field.
...
func (o *AnsibleCollectionVersionResponse) UnmarshalJSON(data []byte) (err error) {
	varAnsibleCollectionVersionResponse := _AnsibleCollectionVersionResponse{}

	err = json.Unmarshal(data, &varAnsibleCollectionVersionResponse)
