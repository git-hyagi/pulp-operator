...
// checks if the OstreeOstreeRepositoryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OstreeOstreeRepositoryResponse{}
...
type _OstreeOstreeRepositoryResponse OstreeOstreeRepositoryResponse
...
func NewOstreeOstreeRepositoryResponse(name string) *OstreeOstreeRepositoryResponse {
	this := OstreeOstreeRepositoryResponse{}
	this.Name = name
...
func (o *OstreeOstreeRepositoryResponse) SetDescriptionNil() {
...
func (o *OstreeOstreeRepositoryResponse) SetRetainRepoVersionsNil() {
...
func (o *OstreeOstreeRepositoryResponse) SetRemoteNil() {
	o.Remote.Set(nil)
}
...
func (o OstreeOstreeRepositoryResponse) MarshalJSON() ([]byte, error) {
...
func (o OstreeOstreeRepositoryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OstreeOstreeRepositoryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOstreeOstreeRepositoryResponse := _OstreeOstreeRepositoryResponse{}

	err = json.Unmarshal(data, &varOstreeOstreeRepositoryResponse)

	if err != nil {
		return err
	}

	*o = OstreeOstreeRepositoryResponse(varOstreeOstreeRepositoryResponse)
...
type NullableOstreeOstreeRepositoryResponse struct {
	value *OstreeOstreeRepositoryResponse
	isSet bool
}

func (v NullableOstreeOstreeRepositoryResponse) Get() *OstreeOstreeRepositoryResponse {
	return v.value
}

func (v *NullableOstreeOstreeRepositoryResponse) Set(val *OstreeOstreeRepositoryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOstreeOstreeRepositoryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOstreeOstreeRepositoryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOstreeOstreeRepositoryResponse(val *OstreeOstreeRepositoryResponse) *NullableOstreeOstreeRepositoryResponse {
	return &NullableOstreeOstreeRepositoryResponse{value: val, isSet: true}
}

func (v NullableOstreeOstreeRepositoryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOstreeOstreeRepositoryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
