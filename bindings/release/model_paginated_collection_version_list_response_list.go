...
func (o *PaginatedCollectionVersionListResponseList) UnmarshalJSON(data []byte) (err error) {
	varPaginatedCollectionVersionListResponseList := _PaginatedCollectionVersionListResponseList{}

	err = json.Unmarshal(data, &varPaginatedCollectionVersionListResponseList)
