...
type PaginateddebReleaseFileResponseList struct {
	...
	Results []DebReleaseFileResponse `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginateddebReleaseFileResponseList PaginateddebReleaseFileResponseList
...
func (o *PaginateddebReleaseFileResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginateddebReleaseFileResponseList := _PaginateddebReleaseFileResponseList{}

	err = json.Unmarshal(data, &varPaginateddebReleaseFileResponseList)

	if err != nil {
		return err
	}

	*o = PaginateddebReleaseFileResponseList(varPaginateddebReleaseFileResponseList)
