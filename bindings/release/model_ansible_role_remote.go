...
// checks if the AnsibleRoleRemote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnsibleRoleRemote{}

// AnsibleRoleRemote A serializer for Ansible Remotes.
type AnsibleRoleRemote struct {
...
type _AnsibleRoleRemote AnsibleRoleRemote
...
func (o *AnsibleRoleRemote) SetCaCertNil() {
	o.CaCert.Set(nil)
}
...
func (o *AnsibleRoleRemote) SetClientCertNil() {
...
func (o *AnsibleRoleRemote) SetClientKeyNil() {
	o.ClientKey.Set(nil)
}
...
func (o *AnsibleRoleRemote) SetProxyUrlNil() {
	o.ProxyUrl.Set(nil)
}
...
func (o *AnsibleRoleRemote) SetProxyUsernameNil() {
...
func (o *AnsibleRoleRemote) SetProxyPasswordNil() {
...
func (o *AnsibleRoleRemote) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o *AnsibleRoleRemote) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *AnsibleRoleRemote) SetDownloadConcurrencyNil() {
...
func (o *AnsibleRoleRemote) SetMaxRetriesNil() {
...
func (o *AnsibleRoleRemote) SetTotalTimeoutNil() {
...
func (o *AnsibleRoleRemote) SetConnectTimeoutNil() {
...
func (o *AnsibleRoleRemote) SetSockConnectTimeoutNil() {
...
func (o *AnsibleRoleRemote) SetSockReadTimeoutNil() {
...
func (o *AnsibleRoleRemote) SetRateLimitNil() {
	o.RateLimit.Set(nil)
}
...
func (o AnsibleRoleRemote) MarshalJSON() ([]byte, error) {
...
func (o AnsibleRoleRemote) ToMap() (map[string]interface{}, error) {
...
func (o *AnsibleRoleRemote) UnmarshalJSON(data []byte) (err error) {
	...
	varAnsibleRoleRemote := _AnsibleRoleRemote{}

	err = json.Unmarshal(data, &varAnsibleRoleRemote)

	if err != nil {
		return err
	}

	*o = AnsibleRoleRemote(varAnsibleRoleRemote)
...
type NullableAnsibleRoleRemote struct {
	value *AnsibleRoleRemote
	isSet bool
}

func (v NullableAnsibleRoleRemote) Get() *AnsibleRoleRemote {
	return v.value
}

func (v *NullableAnsibleRoleRemote) Set(val *AnsibleRoleRemote) {
	v.value = val
	v.isSet = true
}

func (v NullableAnsibleRoleRemote) IsSet() bool {
	return v.isSet
}

func (v *NullableAnsibleRoleRemote) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnsibleRoleRemote(val *AnsibleRoleRemote) *NullableAnsibleRoleRemote {
	return &NullableAnsibleRoleRemote{value: val, isSet: true}
}

func (v NullableAnsibleRoleRemote) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnsibleRoleRemote) UnmarshalJSON(src []byte) error {
	v.isSet = true
