...
func (r AnsibleCopyAPICopyContentRequest) XTaskDiagnostics(xTaskDiagnostics []string) AnsibleCopyAPICopyContentRequest {
...
func (a *AnsibleCopyAPIService) CopyContentExecute(r AnsibleCopyAPICopyContentRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/ansible/copy/"
