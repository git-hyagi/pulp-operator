...
// checks if the PatchedostreeOstreeDistribution type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedostreeOstreeDistribution{}
...
type _PatchedostreeOstreeDistribution PatchedostreeOstreeDistribution
...
func (o *PatchedostreeOstreeDistribution) SetContentGuardNil() {
...
func (o *PatchedostreeOstreeDistribution) SetRepositoryNil() {
...
func (o *PatchedostreeOstreeDistribution) SetRepositoryVersionNil() {
...
func (o PatchedostreeOstreeDistribution) MarshalJSON() ([]byte, error) {
...
func (o PatchedostreeOstreeDistribution) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedostreeOstreeDistribution) UnmarshalJSON(data []byte) (err error) {
	varPatchedostreeOstreeDistribution := _PatchedostreeOstreeDistribution{}

	err = json.Unmarshal(data, &varPatchedostreeOstreeDistribution)

	if err != nil {
		return err
	}

	*o = PatchedostreeOstreeDistribution(varPatchedostreeOstreeDistribution)
...
type NullablePatchedostreeOstreeDistribution struct {
	value *PatchedostreeOstreeDistribution
	isSet bool
}

func (v NullablePatchedostreeOstreeDistribution) Get() *PatchedostreeOstreeDistribution {
	return v.value
}

func (v *NullablePatchedostreeOstreeDistribution) Set(val *PatchedostreeOstreeDistribution) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedostreeOstreeDistribution) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedostreeOstreeDistribution) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedostreeOstreeDistribution(val *PatchedostreeOstreeDistribution) *NullablePatchedostreeOstreeDistribution {
	return &NullablePatchedostreeOstreeDistribution{value: val, isSet: true}
}

func (v NullablePatchedostreeOstreeDistribution) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedostreeOstreeDistribution) UnmarshalJSON(src []byte) error {
	v.isSet = true
