...
type PaginatedGalaxyRoleVersionResponseList struct {
	...
	Results []GalaxyRoleVersionResponse `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedGalaxyRoleVersionResponseList PaginatedGalaxyRoleVersionResponseList
...
func (o *PaginatedGalaxyRoleVersionResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedGalaxyRoleVersionResponseList := _PaginatedGalaxyRoleVersionResponseList{}

	err = json.Unmarshal(data, &varPaginatedGalaxyRoleVersionResponseList)

	if err != nil {
		return err
	}

	*o = PaginatedGalaxyRoleVersionResponseList(varPaginatedGalaxyRoleVersionResponseList)
