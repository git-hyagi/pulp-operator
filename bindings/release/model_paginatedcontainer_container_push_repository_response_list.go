...
type PaginatedcontainerContainerPushRepositoryResponseList struct {
	...
	Results []ContainerContainerPushRepositoryResponse `json:"results"`
...
func (o *PaginatedcontainerContainerPushRepositoryResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPaginatedcontainerContainerPushRepositoryResponseList)
