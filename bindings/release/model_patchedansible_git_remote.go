...
type _PatchedansibleGitRemote PatchedansibleGitRemote
...
func (o *PatchedansibleGitRemote) UnmarshalJSON(data []byte) (err error) {
	varPatchedansibleGitRemote := _PatchedansibleGitRemote{}

	err = json.Unmarshal(data, &varPatchedansibleGitRemote)

	if err != nil {
		return err
	}

	*o = PatchedansibleGitRemote(varPatchedansibleGitRemote)
