...
*/
func (a *DistributionsPullThroughAPIService) DistributionsContainerPullThroughCreate(ctx context.Context) DistributionsPullThroughAPIDistributionsContainerPullThroughCreateRequest {
	return DistributionsPullThroughAPIDistributionsContainerPullThroughCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DistributionsPullThroughAPIService) DistributionsContainerPullThroughCreateExecute(r DistributionsPullThroughAPIDistributionsContainerPullThroughCreateRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/distributions/container/pull-through/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
*/
func (a *DistributionsPullThroughAPIService) DistributionsContainerPullThroughList(ctx context.Context) DistributionsPullThroughAPIDistributionsContainerPullThroughListRequest {
	return DistributionsPullThroughAPIDistributionsContainerPullThroughListRequest{
		ApiService: a,
		ctx: ctx,
	}
