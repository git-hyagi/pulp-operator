...
// checks if the DebVerbatimPublicationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DebVerbatimPublicationResponse{}
...
type _DebVerbatimPublicationResponse DebVerbatimPublicationResponse
...
func (o *DebVerbatimPublicationResponse) UnmarshalJSON(data []byte) (err error) {
	varDebVerbatimPublicationResponse := _DebVerbatimPublicationResponse{}

	err = json.Unmarshal(data, &varDebVerbatimPublicationResponse)

	if err != nil {
		return err
	}

	*o = DebVerbatimPublicationResponse(varDebVerbatimPublicationResponse)
