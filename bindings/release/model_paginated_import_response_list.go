...
// checks if the PaginatedImportResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedImportResponseList{}
...
type PaginatedImportResponseList struct {
	...
	Results []ImportResponse `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedImportResponseList PaginatedImportResponseList
...
func (o PaginatedImportResponseList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedImportResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedImportResponseList := _PaginatedImportResponseList{}

	err = json.Unmarshal(data, &varPaginatedImportResponseList)

	if err != nil {
		return err
	}

	*o = PaginatedImportResponseList(varPaginatedImportResponseList)
