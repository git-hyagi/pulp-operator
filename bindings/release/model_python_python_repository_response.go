...
// checks if the PythonPythonRepositoryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PythonPythonRepositoryResponse{}

// PythonPythonRepositoryResponse Serializer for Python Repositories.
type PythonPythonRepositoryResponse struct {
...
type _PythonPythonRepositoryResponse PythonPythonRepositoryResponse
...
func (o *PythonPythonRepositoryResponse) SetDescriptionNil() {
...
func (o *PythonPythonRepositoryResponse) SetRetainRepoVersionsNil() {
...
func (o *PythonPythonRepositoryResponse) SetRemoteNil() {
	o.Remote.Set(nil)
}
...
func (o PythonPythonRepositoryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PythonPythonRepositoryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPythonPythonRepositoryResponse := _PythonPythonRepositoryResponse{}

	err = json.Unmarshal(data, &varPythonPythonRepositoryResponse)

	if err != nil {
		return err
	}

	*o = PythonPythonRepositoryResponse(varPythonPythonRepositoryResponse)
...
type NullablePythonPythonRepositoryResponse struct {
	value *PythonPythonRepositoryResponse
	isSet bool
}

func (v NullablePythonPythonRepositoryResponse) Get() *PythonPythonRepositoryResponse {
	return v.value
}

func (v *NullablePythonPythonRepositoryResponse) Set(val *PythonPythonRepositoryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePythonPythonRepositoryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePythonPythonRepositoryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePythonPythonRepositoryResponse(val *PythonPythonRepositoryResponse) *NullablePythonPythonRepositoryResponse {
	return &NullablePythonPythonRepositoryResponse{value: val, isSet: true}
}

func (v NullablePythonPythonRepositoryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePythonPythonRepositoryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
