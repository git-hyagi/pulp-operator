...
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesCreateRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentInstallerPackagesAPIContentDebInstallerPackagesCreateRequest {
...
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesCreateRequest) PulpLabels(pulpLabels map[string]string) ContentInstallerPackagesAPIContentDebInstallerPackagesCreateRequest {
...
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesCreateRequest) FileUrl(fileUrl string) ContentInstallerPackagesAPIContentDebInstallerPackagesCreateRequest {
	r.fileUrl = &fileUrl
	return r
}
...
func (a *ContentInstallerPackagesAPIService) ContentDebInstallerPackagesCreateExecute(r ContentInstallerPackagesAPIContentDebInstallerPackagesCreateRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/content/deb/installer_packages/"
...
// List of profilers to use on tasks.
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest) OrphanedFor(orphanedFor float32) ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest {
...
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest) PrnIn(prnIn []string) ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest) PulpLabelSelect(pulpLabelSelect string) ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest {
	r.pulpLabelSelect = &pulpLabelSelect
	return r
}

// Filter results by using NOT, AND and OR operations on other filters
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest) Q(q string) ContentInstallerPackagesAPIContentDebInstallerPackagesListRequest {
	r.q = &q
	return r
}
...
An InstallerPackage represents a '.udeb' installer package.Associated artifacts: Exactly one '.udeb' installer package file.Note that installer packages are currently used exclusively for verbatim publications. The APTpublisher (both simple and structured mode) will not include these packages.
...
// List of profilers to use on tasks.
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesReadRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentInstallerPackagesAPIContentDebInstallerPackagesReadRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
type ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest struct {
	ctx context.Context
	ApiService *ContentInstallerPackagesAPIService
	debInstallerPackageHref string
	setLabel *SetLabel
...
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest) SetLabel(setLabel SetLabel) ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest {
	r.setLabel = &setLabel
	return r
}

// List of profilers to use on tasks.
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest) Execute() (*SetLabelResponse, *http.Response, error) {
	return r.ApiService.ContentDebInstallerPackagesSetLabelExecute(r)
}

/*
ContentDebInstallerPackagesSetLabel Set a label

Set a single pulp_label on the object to a specific value or null.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param debInstallerPackageHref
 @return ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest
*/
func (a *ContentInstallerPackagesAPIService) ContentDebInstallerPackagesSetLabel(ctx context.Context, debInstallerPackageHref string) ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest {
	return ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest{
		ApiService: a,
		ctx: ctx,
		debInstallerPackageHref: debInstallerPackageHref,
...
func (a *ContentInstallerPackagesAPIService) ContentDebInstallerPackagesSetLabelExecute(r ContentInstallerPackagesAPIContentDebInstallerPackagesSetLabelRequest) (*SetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContentInstallerPackagesAPIService.ContentDebInstallerPackagesSetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{deb_installer_package_href}set_label/"
	localVarPath = strings.Replace(localVarPath, "{"+"deb_installer_package_href"+"}", url.PathEscape(parameterValueToString(r.debInstallerPackageHref, "debInstallerPackageHref")), -1)
        localVarPath = strings.Replace(localVarPath, "/%2F", "/", -1)
...
type ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest struct {
	ctx context.Context
	ApiService *ContentInstallerPackagesAPIService
	debInstallerPackageHref string
...
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest) UnsetLabel(unsetLabel UnsetLabel) ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest {
	r.unsetLabel = &unsetLabel
	return r
}

// List of profilers to use on tasks.
func (r ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest) Execute() (*UnsetLabelResponse, *http.Response, error) {
	return r.ApiService.ContentDebInstallerPackagesUnsetLabelExecute(r)
}

/*
ContentDebInstallerPackagesUnsetLabel Unset a label

Unset a single pulp_label on the object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param debInstallerPackageHref
 @return ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest
*/
func (a *ContentInstallerPackagesAPIService) ContentDebInstallerPackagesUnsetLabel(ctx context.Context, debInstallerPackageHref string) ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest {
	return ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest{
		ApiService: a,
		ctx: ctx,
		debInstallerPackageHref: debInstallerPackageHref,
...
func (a *ContentInstallerPackagesAPIService) ContentDebInstallerPackagesUnsetLabelExecute(r ContentInstallerPackagesAPIContentDebInstallerPackagesUnsetLabelRequest) (*UnsetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContentInstallerPackagesAPIService.ContentDebInstallerPackagesUnsetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{deb_installer_package_href}unset_label/"
	localVarPath = strings.Replace(localVarPath, "{"+"deb_installer_package_href"+"}", url.PathEscape(parameterValueToString(r.debInstallerPackageHref, "debInstallerPackageHref")), -1)
        localVarPath = strings.Replace(localVarPath, "/%2F", "/", -1)
