...
func (r ContentPackagesAPIContentDebPackagesCreateRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentPackagesAPIContentDebPackagesCreateRequest {
...
func (r ContentPackagesAPIContentDebPackagesCreateRequest) PulpLabels(pulpLabels map[string]string) ContentPackagesAPIContentDebPackagesCreateRequest {
...
func (r ContentPackagesAPIContentDebPackagesCreateRequest) FileUrl(fileUrl string) ContentPackagesAPIContentDebPackagesCreateRequest {
	r.fileUrl = &fileUrl
	return r
}
...
func (a *ContentPackagesAPIService) ContentDebPackagesCreateExecute(r ContentPackagesAPIContentDebPackagesCreateRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/content/deb/packages/"
...
type ContentPackagesAPIContentDebPackagesListRequest struct {
	...
	packageIcontains *string
	packageIexact *string
	packageIn *[]string
	packageIregex *string
	packageIstartswith *string
	packageRegex *string
	packageStartswith *string
	priority *string
	prnIn *[]string
	pulpHrefIn *[]string
	pulpIdIn *[]string
...
// List of profilers to use on tasks.
func (r ContentPackagesAPIContentDebPackagesListRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentPackagesAPIContentDebPackagesListRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
func (r ContentPackagesAPIContentDebPackagesListRequest) OrphanedFor(orphanedFor float32) ContentPackagesAPIContentDebPackagesListRequest {
...
func (r ContentPackagesAPIContentDebPackagesListRequest) PackageContains(packageContains string) ContentPackagesAPIContentDebPackagesListRequest {
	r.packageContains = &packageContains
	return r
}

// Filter results where package contains value
func (r ContentPackagesAPIContentDebPackagesListRequest) PackageIcontains(packageIcontains string) ContentPackagesAPIContentDebPackagesListRequest {
	r.packageIcontains = &packageIcontains
	return r
}

// Filter results where package matches value
func (r ContentPackagesAPIContentDebPackagesListRequest) PackageIexact(packageIexact string) ContentPackagesAPIContentDebPackagesListRequest {
	r.packageIexact = &packageIexact
	return r
}

// Filter results where package is in a comma-separated list of values
func (r ContentPackagesAPIContentDebPackagesListRequest) PackageIn(packageIn []string) ContentPackagesAPIContentDebPackagesListRequest {
	r.packageIn = &packageIn
	return r
}

// Filter results where package matches regex value
func (r ContentPackagesAPIContentDebPackagesListRequest) PackageIregex(packageIregex string) ContentPackagesAPIContentDebPackagesListRequest {
	r.packageIregex = &packageIregex
	return r
}

// Filter results where package starts with value
func (r ContentPackagesAPIContentDebPackagesListRequest) PackageIstartswith(packageIstartswith string) ContentPackagesAPIContentDebPackagesListRequest {
	r.packageIstartswith = &packageIstartswith
	return r
}

// Filter results where package matches regex value
func (r ContentPackagesAPIContentDebPackagesListRequest) PackageRegex(packageRegex string) ContentPackagesAPIContentDebPackagesListRequest {
	r.packageRegex = &packageRegex
	return r
}

// Filter results where package starts with value
func (r ContentPackagesAPIContentDebPackagesListRequest) PackageStartswith(packageStartswith string) ContentPackagesAPIContentDebPackagesListRequest {
	r.packageStartswith = &packageStartswith
	return r
}
...
func (r ContentPackagesAPIContentDebPackagesListRequest) PrnIn(prnIn []string) ContentPackagesAPIContentDebPackagesListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (r ContentPackagesAPIContentDebPackagesListRequest) PulpLabelSelect(pulpLabelSelect string) ContentPackagesAPIContentDebPackagesListRequest {
	r.pulpLabelSelect = &pulpLabelSelect
	return r
}

// Filter results by using NOT, AND and OR operations on other filters
func (r ContentPackagesAPIContentDebPackagesListRequest) Q(q string) ContentPackagesAPIContentDebPackagesListRequest {
	r.q = &q
	return r
}
...
//     Must be a comma-separated string: \&quot;release_href,repository_or_repository_version_href\&quot;    release_href: Filter results where Package in Release    repository_or_repository_version_href: The RepositoryVersion href to filter by, or Repository        href (assume latest version)    
func (r ContentPackagesAPIContentDebPackagesListRequest) Release(release string) ContentPackagesAPIContentDebPackagesListRequest {
	r.release = &release
	return r
}

//     Must be a comma-separated string: \&quot;release_component_href,repository_or_repository_version_href\&quot;    release_component_href: Filter results where Package in ReleaseComponent    repository_or_repository_version_href: The RepositoryVersion href to filter by, or Repository        href (assume latest version)    
func (r ContentPackagesAPIContentDebPackagesListRequest) ReleaseComponent(releaseComponent string) ContentPackagesAPIContentDebPackagesListRequest {
...
func (a *ContentPackagesAPIService) ContentDebPackagesListExecute(r ContentPackagesAPIContentDebPackagesListRequest) (*PaginateddebPackageResponseList, *http.Response, error) {
	...
	if r.autoBuiltPackage != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "auto_built_package", r.autoBuiltPackage, "form", "")
	}
	if r.buildEssential != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "build_essential", r.buildEssential, "form", "")
	}
	if r.builtUsing != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "built_using", r.builtUsing, "form", "")
	}
	if r.essential != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "essential", r.essential, "form", "")
	}
	if r.installedSize != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "installed_size", r.installedSize, "form", "")
	}
	if r.limit != nil {
	...
	if r.multiArch != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "multi_arch", r.multiArch, "form", "")
	}
	if r.offset != nil {
	...
	if r.originalMaintainer != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "original_maintainer", r.originalMaintainer, "form", "")
	}
	...
	if r.packageContains != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "package__contains", r.packageContains, "form", "")
	}
	if r.packageIcontains != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "package__icontains", r.packageIcontains, "form", "")
	}
	if r.packageIexact != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "package__iexact", r.packageIexact, "form", "")
	}
	if r.packageIn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "package__in", r.packageIn, "form", "csv")
	}
	if r.packageIregex != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "package__iregex", r.packageIregex, "form", "")
	}
	if r.packageIstartswith != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "package__istartswith", r.packageIstartswith, "form", "")
	}
	if r.packageRegex != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "package__regex", r.packageRegex, "form", "")
	}
	if r.packageStartswith != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "package__startswith", r.packageStartswith, "form", "")
	}
	if r.priority != nil {
...
// List of profilers to use on tasks.
func (r ContentPackagesAPIContentDebPackagesReadRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentPackagesAPIContentDebPackagesReadRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
type ContentPackagesAPIContentDebPackagesSetLabelRequest struct {
	ctx context.Context
	ApiService *ContentPackagesAPIService
	debPackageHref string
	setLabel *SetLabel
...
func (r ContentPackagesAPIContentDebPackagesSetLabelRequest) SetLabel(setLabel SetLabel) ContentPackagesAPIContentDebPackagesSetLabelRequest {
	r.setLabel = &setLabel
	return r
}

// List of profilers to use on tasks.
func (r ContentPackagesAPIContentDebPackagesSetLabelRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentPackagesAPIContentDebPackagesSetLabelRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r ContentPackagesAPIContentDebPackagesSetLabelRequest) Execute() (*SetLabelResponse, *http.Response, error) {
	return r.ApiService.ContentDebPackagesSetLabelExecute(r)
}

/*
ContentDebPackagesSetLabel Set a label

Set a single pulp_label on the object to a specific value or null.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param debPackageHref
 @return ContentPackagesAPIContentDebPackagesSetLabelRequest
*/
func (a *ContentPackagesAPIService) ContentDebPackagesSetLabel(ctx context.Context, debPackageHref string) ContentPackagesAPIContentDebPackagesSetLabelRequest {
	return ContentPackagesAPIContentDebPackagesSetLabelRequest{
		ApiService: a,
		ctx: ctx,
		debPackageHref: debPackageHref,
...
func (a *ContentPackagesAPIService) ContentDebPackagesSetLabelExecute(r ContentPackagesAPIContentDebPackagesSetLabelRequest) (*SetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContentPackagesAPIService.ContentDebPackagesSetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{deb_package_href}set_label/"
	localVarPath = strings.Replace(localVarPath, "{"+"deb_package_href"+"}", url.PathEscape(parameterValueToString(r.debPackageHref, "debPackageHref")), -1)
        localVarPath = strings.Replace(localVarPath, "/%2F", "/", -1)
...
type ContentPackagesAPIContentDebPackagesUnsetLabelRequest struct {
	ctx context.Context
	ApiService *ContentPackagesAPIService
	debPackageHref string
...
func (r ContentPackagesAPIContentDebPackagesUnsetLabelRequest) UnsetLabel(unsetLabel UnsetLabel) ContentPackagesAPIContentDebPackagesUnsetLabelRequest {
	r.unsetLabel = &unsetLabel
	return r
}

// List of profilers to use on tasks.
func (r ContentPackagesAPIContentDebPackagesUnsetLabelRequest) XTaskDiagnostics(xTaskDiagnostics []string) ContentPackagesAPIContentDebPackagesUnsetLabelRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

func (r ContentPackagesAPIContentDebPackagesUnsetLabelRequest) Execute() (*UnsetLabelResponse, *http.Response, error) {
	return r.ApiService.ContentDebPackagesUnsetLabelExecute(r)
}

/*
ContentDebPackagesUnsetLabel Unset a label

Unset a single pulp_label on the object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param debPackageHref
 @return ContentPackagesAPIContentDebPackagesUnsetLabelRequest
*/
func (a *ContentPackagesAPIService) ContentDebPackagesUnsetLabel(ctx context.Context, debPackageHref string) ContentPackagesAPIContentDebPackagesUnsetLabelRequest {
	return ContentPackagesAPIContentDebPackagesUnsetLabelRequest{
		ApiService: a,
		ctx: ctx,
		debPackageHref: debPackageHref,
...
func (a *ContentPackagesAPIService) ContentDebPackagesUnsetLabelExecute(r ContentPackagesAPIContentDebPackagesUnsetLabelRequest) (*UnsetLabelResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContentPackagesAPIService.ContentDebPackagesUnsetLabel")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{deb_package_href}unset_label/"
	localVarPath = strings.Replace(localVarPath, "{"+"deb_package_href"+"}", url.PathEscape(parameterValueToString(r.debPackageHref, "debPackageHref")), -1)
        localVarPath = strings.Replace(localVarPath, "/%2F", "/", -1)
...
*/
func (a *ContentPackagesAPIService) ContentNpmPackagesCreate(ctx context.Context) ContentPackagesAPIContentNpmPackagesCreateRequest {
	return ContentPackagesAPIContentNpmPackagesCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ContentPackagesAPIService) ContentNpmPackagesCreateExecute(r ContentPackagesAPIContentNpmPackagesCreateRequest) (*NpmPackageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/content/npm/packages/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.relativePath == nil {
...
*/
func (a *ContentPackagesAPIService) ContentNpmPackagesList(ctx context.Context) ContentPackagesAPIContentNpmPackagesListRequest {
	return ContentPackagesAPIContentNpmPackagesListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ContentPackagesAPIService) ContentPythonPackagesCreateExecute(r ContentPackagesAPIContentPythonPackagesCreateRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/content/python/packages/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.relativePath == nil {
...
*/
func (a *ContentPackagesAPIService) ContentPythonPackagesUpload(ctx context.Context) ContentPackagesAPIContentPythonPackagesUploadRequest {
	return ContentPackagesAPIContentPythonPackagesUploadRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ContentPackagesAPIService) ContentPythonPackagesUploadExecute(r ContentPackagesAPIContentPythonPackagesUploadRequest) (*PythonPythonPackageContentResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/content/python/packages/upload/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
func (a *ContentPackagesAPIService) ContentRpmPackagesCreateExecute(r ContentPackagesAPIContentRpmPackagesCreateRequest) (*AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/content/rpm/packages/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
*/
func (a *ContentPackagesAPIService) ContentRpmPackagesUpload(ctx context.Context) ContentPackagesAPIContentRpmPackagesUploadRequest {
	return ContentPackagesAPIContentRpmPackagesUploadRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ContentPackagesAPIService) ContentRpmPackagesUploadExecute(r ContentPackagesAPIContentRpmPackagesUploadRequest) (*RpmPackageResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/content/rpm/packages/upload/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
