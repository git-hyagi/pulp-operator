...
// checks if the PatchedfileFileRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedfileFileRepository{}
...
func NewPatchedfileFileRepository() *PatchedfileFileRepository {
	this := PatchedfileFileRepository{}
...
func (o *PatchedfileFileRepository) SetDescriptionNil() {
...
func (o *PatchedfileFileRepository) SetRetainRepoVersionsNil() {
...
func (o *PatchedfileFileRepository) SetRemoteNil() {
	o.Remote.Set(nil)
}
...
func (o *PatchedfileFileRepository) SetManifestNil() {
	o.Manifest.Set(nil)
}
...
func (o PatchedfileFileRepository) MarshalJSON() ([]byte, error) {
...
func (o PatchedfileFileRepository) ToMap() (map[string]interface{}, error) {
...
type NullablePatchedfileFileRepository struct {
	value *PatchedfileFileRepository
	isSet bool
}

func (v NullablePatchedfileFileRepository) Get() *PatchedfileFileRepository {
	return v.value
}

func (v *NullablePatchedfileFileRepository) Set(val *PatchedfileFileRepository) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedfileFileRepository) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedfileFileRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedfileFileRepository(val *PatchedfileFileRepository) *NullablePatchedfileFileRepository {
	return &NullablePatchedfileFileRepository{value: val, isSet: true}
}

func (v NullablePatchedfileFileRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedfileFileRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
