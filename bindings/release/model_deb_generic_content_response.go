...
type _DebGenericContentResponse DebGenericContentResponse
...
func (o *DebGenericContentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDebGenericContentResponse := _DebGenericContentResponse{}

	err = json.Unmarshal(data, &varDebGenericContentResponse)

	if err != nil {
		return err
	}

	*o = DebGenericContentResponse(varDebGenericContentResponse)
