...
type _MavenMavenDistributionResponse MavenMavenDistributionResponse
...
func (o *MavenMavenDistributionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMavenMavenDistributionResponse := _MavenMavenDistributionResponse{}

	err = json.Unmarshal(data, &varMavenMavenDistributionResponse)

	if err != nil {
		return err
	}

	*o = MavenMavenDistributionResponse(varMavenMavenDistributionResponse)
