...
// ProgressReportResponse Base serializer for use with [pulpcore.app.models.Model][]This ensures that all Serializers provide values for the 'pulp_href` field.The class provides a default for the ``ref_name`` attribute in theModelSerializers's ``Meta`` class. This ensures that the OpenAPI definitionsof plugins are namespaced properly.
...
type _ProgressReportResponse ProgressReportResponse
...
func (o ProgressReportResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ProgressReportResponse) UnmarshalJSON(data []byte) (err error) {
	varProgressReportResponse := _ProgressReportResponse{}

	err = json.Unmarshal(data, &varProgressReportResponse)

	if err != nil {
		return err
	}

	*o = ProgressReportResponse(varProgressReportResponse)
