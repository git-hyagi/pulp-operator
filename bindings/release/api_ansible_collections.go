...
func (r AnsibleCollectionsAPIAnsibleCollectionsAddRoleRequest) XTaskDiagnostics(xTaskDiagnostics []string) AnsibleCollectionsAPIAnsibleCollectionsAddRoleRequest {
...
/*
AnsibleCollectionsAddRole Add a role
...
// List of profilers to use on tasks.
func (r AnsibleCollectionsAPIAnsibleCollectionsListRequest) XTaskDiagnostics(xTaskDiagnostics []string) AnsibleCollectionsAPIAnsibleCollectionsListRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
func (r AnsibleCollectionsAPIAnsibleCollectionsListRequest) PrnIn(prnIn []string) AnsibleCollectionsAPIAnsibleCollectionsListRequest {
	r.prnIn = &prnIn
	return r
}
...
func (r AnsibleCollectionsAPIAnsibleCollectionsListRequest) Q(q string) AnsibleCollectionsAPIAnsibleCollectionsListRequest {
	r.q = &q
	return r
}
...
func (a *AnsibleCollectionsAPIService) AnsibleCollectionsListExecute(r AnsibleCollectionsAPIAnsibleCollectionsListRequest) (*PaginatedansibleCollectionResponseList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/ansible/collections/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
// List of profilers to use on tasks.
func (r AnsibleCollectionsAPIAnsibleCollectionsListRolesRequest) XTaskDiagnostics(xTaskDiagnostics []string) AnsibleCollectionsAPIAnsibleCollectionsListRolesRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
/*
AnsibleCollectionsListRoles List roles
...
// List of profilers to use on tasks.
func (r AnsibleCollectionsAPIAnsibleCollectionsMyPermissionsRequest) XTaskDiagnostics(xTaskDiagnostics []string) AnsibleCollectionsAPIAnsibleCollectionsMyPermissionsRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
/*
AnsibleCollectionsMyPermissions List user permissions
...
type AnsibleCollectionsAPIAnsibleCollectionsReadRequest struct {
	ctx context.Context
	ApiService *AnsibleCollectionsAPIService
	ansibleCollectionHref string
	xTaskDiagnostics *[]string
...
// List of profilers to use on tasks.
func (r AnsibleCollectionsAPIAnsibleCollectionsReadRequest) XTaskDiagnostics(xTaskDiagnostics []string) AnsibleCollectionsAPIAnsibleCollectionsReadRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}

// A list of fields to include in the response.
func (r AnsibleCollectionsAPIAnsibleCollectionsReadRequest) Fields(fields []string) AnsibleCollectionsAPIAnsibleCollectionsReadRequest {
	r.fields = &fields
	return r
}

// A list of fields to exclude from the response.
func (r AnsibleCollectionsAPIAnsibleCollectionsReadRequest) ExcludeFields(excludeFields []string) AnsibleCollectionsAPIAnsibleCollectionsReadRequest {
	r.excludeFields = &excludeFields
	return r
}

func (r AnsibleCollectionsAPIAnsibleCollectionsReadRequest) Execute() (*AnsibleCollectionResponse, *http.Response, error) {
	return r.ApiService.AnsibleCollectionsReadExecute(r)
}

/*
AnsibleCollectionsRead Inspect a collection

Viewset for Ansible Collections.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ansibleCollectionHref
 @return AnsibleCollectionsAPIAnsibleCollectionsReadRequest
*/
func (a *AnsibleCollectionsAPIService) AnsibleCollectionsRead(ctx context.Context, ansibleCollectionHref string) AnsibleCollectionsAPIAnsibleCollectionsReadRequest {
	return AnsibleCollectionsAPIAnsibleCollectionsReadRequest{
		ApiService: a,
		ctx: ctx,
		ansibleCollectionHref: ansibleCollectionHref,
...
func (a *AnsibleCollectionsAPIService) AnsibleCollectionsReadExecute(r AnsibleCollectionsAPIAnsibleCollectionsReadRequest) (*AnsibleCollectionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AnsibleCollectionsAPIService.AnsibleCollectionsRead")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// List of profilers to use on tasks.
func (r AnsibleCollectionsAPIAnsibleCollectionsRemoveRoleRequest) XTaskDiagnostics(xTaskDiagnostics []string) AnsibleCollectionsAPIAnsibleCollectionsRemoveRoleRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
...
/*
AnsibleCollectionsRemoveRole Remove a role
...
// List of profilers to use on tasks.
func (r AnsibleCollectionsAPIUploadCollectionRequest) XTaskDiagnostics(xTaskDiagnostics []string) AnsibleCollectionsAPIUploadCollectionRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
