...
type _RecursiveManage RecursiveManage
...
func (o *RecursiveManage) UnmarshalJSON(data []byte) (err error) {
	varRecursiveManage := _RecursiveManage{}

	err = json.Unmarshal(data, &varRecursiveManage)

	if err != nil {
		return err
	}

	*o = RecursiveManage(varRecursiveManage)
