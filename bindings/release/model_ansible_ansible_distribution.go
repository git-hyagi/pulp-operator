...
type _AnsibleAnsibleDistribution AnsibleAnsibleDistribution
...
func (o *AnsibleAnsibleDistribution) UnmarshalJSON(data []byte) (err error) {
	...
	varAnsibleAnsibleDistribution := _AnsibleAnsibleDistribution{}

	err = json.Unmarshal(data, &varAnsibleAnsibleDistribution)

	if err != nil {
		return err
	}

	*o = AnsibleAnsibleDistribution(varAnsibleAnsibleDistribution)
