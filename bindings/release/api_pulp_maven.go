...
func (r PulpMavenAPIPulpMavenGetRequest) XTaskDiagnostics(xTaskDiagnostics []string) PulpMavenAPIPulpMavenGetRequest {
...
// List of profilers to use on tasks.
func (r PulpMavenAPIPulpMavenPutRequest) XTaskDiagnostics(xTaskDiagnostics []string) PulpMavenAPIPulpMavenPutRequest {
	r.xTaskDiagnostics = &xTaskDiagnostics
	return r
}
