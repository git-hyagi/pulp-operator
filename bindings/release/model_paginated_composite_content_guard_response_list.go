...
// checks if the PaginatedCompositeContentGuardResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedCompositeContentGuardResponseList{}

// PaginatedCompositeContentGuardResponseList struct for PaginatedCompositeContentGuardResponseList
...
func NewPaginatedCompositeContentGuardResponseList(count int32, results []CompositeContentGuardResponse) *PaginatedCompositeContentGuardResponseList {
	this := PaginatedCompositeContentGuardResponseList{}
	this.Count = count
...
func (o *PaginatedCompositeContentGuardResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedCompositeContentGuardResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedCompositeContentGuardResponseList) GetResults() []CompositeContentGuardResponse {
	if o == nil {
		var ret []CompositeContentGuardResponse
		return ret
	}
...
func (o PaginatedCompositeContentGuardResponseList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedCompositeContentGuardResponseList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedCompositeContentGuardResponseList struct {
	value *PaginatedCompositeContentGuardResponseList
	isSet bool
}

func (v NullablePaginatedCompositeContentGuardResponseList) Get() *PaginatedCompositeContentGuardResponseList {
	return v.value
}

func (v *NullablePaginatedCompositeContentGuardResponseList) Set(val *PaginatedCompositeContentGuardResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCompositeContentGuardResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCompositeContentGuardResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCompositeContentGuardResponseList(val *PaginatedCompositeContentGuardResponseList) *NullablePaginatedCompositeContentGuardResponseList {
	return &NullablePaginatedCompositeContentGuardResponseList{value: val, isSet: true}
}

func (v NullablePaginatedCompositeContentGuardResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCompositeContentGuardResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
