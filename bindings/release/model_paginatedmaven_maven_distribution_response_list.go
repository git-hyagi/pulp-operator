...
type PaginatedmavenMavenDistributionResponseList struct {
	...
	Results []MavenMavenDistributionResponse `json:"results"`
...
func (o *PaginatedmavenMavenDistributionResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPaginatedmavenMavenDistributionResponseList)
