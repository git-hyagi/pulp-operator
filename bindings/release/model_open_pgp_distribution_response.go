...
// checks if the OpenPGPDistributionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenPGPDistributionResponse{}
...
type OpenPGPDistributionResponse struct {
...
type _OpenPGPDistributionResponse OpenPGPDistributionResponse
...
func NewOpenPGPDistributionResponse(basePath string, name string) *OpenPGPDistributionResponse {
	this := OpenPGPDistributionResponse{}
...
func (o *OpenPGPDistributionResponse) SetContentGuardNil() {
...
func (o *OpenPGPDistributionResponse) SetRepositoryNil() {
...
func (o *OpenPGPDistributionResponse) SetRepositoryVersionNil() {
...
func (o OpenPGPDistributionResponse) MarshalJSON() ([]byte, error) {
...
func (o OpenPGPDistributionResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OpenPGPDistributionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenPGPDistributionResponse := _OpenPGPDistributionResponse{}

	err = json.Unmarshal(data, &varOpenPGPDistributionResponse)

	if err != nil {
		return err
	}

	*o = OpenPGPDistributionResponse(varOpenPGPDistributionResponse)
...
type NullableOpenPGPDistributionResponse struct {
	value *OpenPGPDistributionResponse
	isSet bool
}

func (v NullableOpenPGPDistributionResponse) Get() *OpenPGPDistributionResponse {
	return v.value
}

func (v *NullableOpenPGPDistributionResponse) Set(val *OpenPGPDistributionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenPGPDistributionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenPGPDistributionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenPGPDistributionResponse(val *OpenPGPDistributionResponse) *NullableOpenPGPDistributionResponse {
	return &NullableOpenPGPDistributionResponse{value: val, isSet: true}
}

func (v NullableOpenPGPDistributionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenPGPDistributionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
