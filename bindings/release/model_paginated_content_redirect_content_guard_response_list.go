...
// checks if the PaginatedContentRedirectContentGuardResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedContentRedirectContentGuardResponseList{}

// PaginatedContentRedirectContentGuardResponseList struct for PaginatedContentRedirectContentGuardResponseList
type PaginatedContentRedirectContentGuardResponseList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []ContentRedirectContentGuardResponse `json:"results"`
...
func NewPaginatedContentRedirectContentGuardResponseList(count int32, results []ContentRedirectContentGuardResponse) *PaginatedContentRedirectContentGuardResponseList {
	this := PaginatedContentRedirectContentGuardResponseList{}
	this.Count = count
...
func (o *PaginatedContentRedirectContentGuardResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedContentRedirectContentGuardResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedContentRedirectContentGuardResponseList) GetResults() []ContentRedirectContentGuardResponse {
	if o == nil {
		var ret []ContentRedirectContentGuardResponse
		return ret
	}
...
func (o PaginatedContentRedirectContentGuardResponseList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedContentRedirectContentGuardResponseList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedContentRedirectContentGuardResponseList struct {
	value *PaginatedContentRedirectContentGuardResponseList
	isSet bool
}

func (v NullablePaginatedContentRedirectContentGuardResponseList) Get() *PaginatedContentRedirectContentGuardResponseList {
	return v.value
}

func (v *NullablePaginatedContentRedirectContentGuardResponseList) Set(val *PaginatedContentRedirectContentGuardResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedContentRedirectContentGuardResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedContentRedirectContentGuardResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedContentRedirectContentGuardResponseList(val *PaginatedContentRedirectContentGuardResponseList) *NullablePaginatedContentRedirectContentGuardResponseList {
	return &NullablePaginatedContentRedirectContentGuardResponseList{value: val, isSet: true}
}

func (v NullablePaginatedContentRedirectContentGuardResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedContentRedirectContentGuardResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
