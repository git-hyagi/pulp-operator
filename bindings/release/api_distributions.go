...
// Pulp type* &#x60;core.artifact&#x60; - core.artifact* &#x60;core.openpgp&#x60; - core.openpgp* &#x60;ansible.ansible&#x60; - ansible.ansible* &#x60;container.pull-through&#x60; - container.pull-through* &#x60;container.container&#x60; - container.container* &#x60;deb.apt-distribution&#x60; - deb.apt-distribution* &#x60;maven.maven&#x60; - maven.maven* &#x60;npm.npm&#x60; - npm.npm* &#x60;ostree.ostree&#x60; - ostree.ostree* &#x60;python.python&#x60; - python.python* &#x60;rpm.rpm&#x60; - rpm.rpm* &#x60;file.file&#x60; - file.file
...
func (a *DistributionsAPIService) DistributionsListExecute(r DistributionsAPIDistributionsListRequest) (*PaginatedDistributionResponseList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/distributions/"
