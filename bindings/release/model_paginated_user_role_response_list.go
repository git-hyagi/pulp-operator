...
// checks if the PaginatedUserRoleResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedUserRoleResponseList{}

// PaginatedUserRoleResponseList struct for PaginatedUserRoleResponseList
type PaginatedUserRoleResponseList struct {
	Count int32 `json:"count"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []UserRoleResponse `json:"results"`
...
func NewPaginatedUserRoleResponseList(count int32, results []UserRoleResponse) *PaginatedUserRoleResponseList {
	this := PaginatedUserRoleResponseList{}
	this.Count = count
...
func (o *PaginatedUserRoleResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedUserRoleResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedUserRoleResponseList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedUserRoleResponseList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedUserRoleResponseList struct {
	value *PaginatedUserRoleResponseList
	isSet bool
}

func (v NullablePaginatedUserRoleResponseList) Get() *PaginatedUserRoleResponseList {
	return v.value
}

func (v *NullablePaginatedUserRoleResponseList) Set(val *PaginatedUserRoleResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedUserRoleResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedUserRoleResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedUserRoleResponseList(val *PaginatedUserRoleResponseList) *NullablePaginatedUserRoleResponseList {
	return &NullablePaginatedUserRoleResponseList{value: val, isSet: true}
}

func (v NullablePaginatedUserRoleResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedUserRoleResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
