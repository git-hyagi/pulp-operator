...
// checks if the MavenMavenRepositoryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MavenMavenRepositoryResponse{}

// MavenMavenRepositoryResponse Serializer for Maven Repositories.
type MavenMavenRepositoryResponse struct {
...
type _MavenMavenRepositoryResponse MavenMavenRepositoryResponse
...
func NewMavenMavenRepositoryResponse(name string) *MavenMavenRepositoryResponse {
	this := MavenMavenRepositoryResponse{}
	this.Name = name
	return &this
}
...
func (o *MavenMavenRepositoryResponse) SetDescriptionNil() {
...
func (o *MavenMavenRepositoryResponse) SetRetainRepoVersionsNil() {
...
func (o *MavenMavenRepositoryResponse) SetRemoteNil() {
	o.Remote.Set(nil)
}
...
func (o MavenMavenRepositoryResponse) MarshalJSON() ([]byte, error) {
...
func (o MavenMavenRepositoryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MavenMavenRepositoryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMavenMavenRepositoryResponse := _MavenMavenRepositoryResponse{}

	err = json.Unmarshal(data, &varMavenMavenRepositoryResponse)

	if err != nil {
		return err
	}

	*o = MavenMavenRepositoryResponse(varMavenMavenRepositoryResponse)
...
type NullableMavenMavenRepositoryResponse struct {
	value *MavenMavenRepositoryResponse
	isSet bool
}

func (v NullableMavenMavenRepositoryResponse) Get() *MavenMavenRepositoryResponse {
	return v.value
}

func (v *NullableMavenMavenRepositoryResponse) Set(val *MavenMavenRepositoryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMavenMavenRepositoryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMavenMavenRepositoryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMavenMavenRepositoryResponse(val *MavenMavenRepositoryResponse) *NullableMavenMavenRepositoryResponse {
	return &NullableMavenMavenRepositoryResponse{value: val, isSet: true}
}

func (v NullableMavenMavenRepositoryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMavenMavenRepositoryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
