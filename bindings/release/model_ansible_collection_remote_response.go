...
type AnsibleCollectionRemoteResponse struct {
	...
	LastSyncTask *string `json:"last_sync_task,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AnsibleCollectionRemoteResponse AnsibleCollectionRemoteResponse
...
// GetLastSyncTask returns the LastSyncTask field value if set, zero value otherwise.
func (o *AnsibleCollectionRemoteResponse) GetLastSyncTask() string {
	if o == nil || IsNil(o.LastSyncTask) {
		var ret string
		return ret
	}
	return *o.LastSyncTask
}

// GetLastSyncTaskOk returns a tuple with the LastSyncTask field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AnsibleCollectionRemoteResponse) GetLastSyncTaskOk() (*string, bool) {
	if o == nil || IsNil(o.LastSyncTask) {
		return nil, false
	}
	return o.LastSyncTask, true
}
...
// SetLastSyncTask gets a reference to the given string and assigns it to the LastSyncTask field.
...
func (o *AnsibleCollectionRemoteResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAnsibleCollectionRemoteResponse := _AnsibleCollectionRemoteResponse{}

	err = json.Unmarshal(data, &varAnsibleCollectionRemoteResponse)

	if err != nil {
		return err
	}

	*o = AnsibleCollectionRemoteResponse(varAnsibleCollectionRemoteResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "last_sync_task")
