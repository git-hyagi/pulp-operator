...
type _OstreeOstreeRepository OstreeOstreeRepository
...
func (o *OstreeOstreeRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varOstreeOstreeRepository := _OstreeOstreeRepository{}

	err = json.Unmarshal(data, &varOstreeOstreeRepository)

	if err != nil {
		return err
	}

	*o = OstreeOstreeRepository(varOstreeOstreeRepository)
