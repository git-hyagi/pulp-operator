...
type AnsibleAnsibleRepositoryResponse struct {
	...
	LastSyncTask interface{} `json:"last_sync_task,omitempty"`
	Private *bool `json:"private,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AnsibleAnsibleRepositoryResponse AnsibleAnsibleRepositoryResponse
...
// GetLastSyncTask returns the LastSyncTask field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetLastSyncTask gets a reference to the given interface{} and assigns it to the LastSyncTask field.
...
func (o *AnsibleAnsibleRepositoryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAnsibleAnsibleRepositoryResponse := _AnsibleAnsibleRepositoryResponse{}

	err = json.Unmarshal(data, &varAnsibleAnsibleRepositoryResponse)

	if err != nil {
		return err
	}

	*o = AnsibleAnsibleRepositoryResponse(varAnsibleAnsibleRepositoryResponse)
