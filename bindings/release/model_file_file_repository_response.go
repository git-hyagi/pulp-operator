...
func (o *FileFileRepositoryResponse) SetDescriptionNil() {
...
func (o *FileFileRepositoryResponse) SetRetainRepoVersionsNil() {
...
func (o *FileFileRepositoryResponse) SetRemoteNil() {
	o.Remote.Set(nil)
}
...
func (o *FileFileRepositoryResponse) SetManifestNil() {
	o.Manifest.Set(nil)
}
...
func (o *FileFileRepositoryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFileFileRepositoryResponse)
