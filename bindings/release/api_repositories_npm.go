...
*/
func (a *RepositoriesNpmAPIService) RepositoriesNpmNpmCreate(ctx context.Context) RepositoriesNpmAPIRepositoriesNpmNpmCreateRequest {
	return RepositoriesNpmAPIRepositoriesNpmNpmCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RepositoriesNpmAPIService) RepositoriesNpmNpmCreateExecute(r RepositoriesNpmAPIRepositoriesNpmNpmCreateRequest) (*NpmNpmRepositoryResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/repositories/npm/npm/"
...
*/
func (a *RepositoriesNpmAPIService) RepositoriesNpmNpmList(ctx context.Context) RepositoriesNpmAPIRepositoriesNpmNpmListRequest {
	return RepositoriesNpmAPIRepositoriesNpmNpmListRequest{
		ApiService: a,
		ctx: ctx,
	}
