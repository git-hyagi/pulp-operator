...
// NamespaceLink Provides backwards compatible interface for links with the legacyGalaxyNG API.
...
func (o *NamespaceLink) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNamespaceLink)
