...
func (o *PaginatedostreeOstreeDistributionResponseList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPaginatedostreeOstreeDistributionResponseList)
