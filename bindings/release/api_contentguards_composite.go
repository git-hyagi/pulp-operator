...
*/
func (a *ContentguardsCompositeAPIService) ContentguardsCoreCompositeCreate(ctx context.Context) ContentguardsCompositeAPIContentguardsCoreCompositeCreateRequest {
	return ContentguardsCompositeAPIContentguardsCoreCompositeCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ContentguardsCompositeAPIService) ContentguardsCoreCompositeCreateExecute(r ContentguardsCompositeAPIContentguardsCoreCompositeCreateRequest) (*CompositeContentGuardResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v3/contentguards/core/composite/"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
*/
func (a *ContentguardsCompositeAPIService) ContentguardsCoreCompositeList(ctx context.Context) ContentguardsCompositeAPIContentguardsCoreCompositeListRequest {
	return ContentguardsCompositeAPIContentguardsCoreCompositeListRequest{
		ApiService: a,
		ctx: ctx,
	}
