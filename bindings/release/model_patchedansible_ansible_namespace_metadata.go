...
type PatchedansibleAnsibleNamespaceMetadata struct {
	...
	Name *string `json:"name,omitempty" validate:"regexp=^(?!.*__)[a-z]+[0-9a-z_]*$"`
...
func (o *PatchedansibleAnsibleNamespaceMetadata) UnmarshalJSON(data []byte) (err error) {
	varPatchedansibleAnsibleNamespaceMetadata := _PatchedansibleAnsibleNamespaceMetadata{}

	err = json.Unmarshal(data, &varPatchedansibleAnsibleNamespaceMetadata)
